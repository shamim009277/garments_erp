                                ...
                                <tr id="row-{{ $module->id }}">
                                    ...
                                    <td>
                                        <div class="square-switch">
                                            <input type="checkbox" id="square-switch{{ $module->id }}"class="module-toggle" data-id="{{ $module->id }}" switch="success" {{ $module->is_active ? 'checked' : '' }} />
                                            <label for="square-switch{{ $module->id }}" data-on-label="Yes"data-off-label="No" style="margin: 0px; vertical-align: middle;"></label>
                                        </div>
                                    </td>
                                    <td>
