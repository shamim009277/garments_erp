            ...
            <div class="card alert-primary alert-top-border">
                <div class="card-body px-0 py-0" style="min-height: 500px;">
                    <ul class="nav nav-tabs nav-tabs-custom" role="tablist" style="background-color: #5559ca; color: white;border-radius: 0px !important;">
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 1])); ?>" class="nav-link border-none <?php echo e($tab == 1 ? 'active' : ''); ?>" title="Basic" role="tab" style="hover: white !important;">
                                <span class="d-block d-sm-none"><i class="fa fa-user"></i></span>
                                <span class="d-none d-sm-block">Basic</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 2])); ?>" class="nav-link border-none <?php echo e($tab == 2 ? 'active' : ''); ?>" title="Salary Info" role="tab">
                                <span class="d-block d-sm-none"><i class="fa fa-credit-card"></i></span>
                                <span class="d-none d-sm-block">Salary Info</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 3])); ?>" class="nav-link border-none <?php echo e($tab == 3 ? 'active' : ''); ?>" title="Education" role="tab">
                                <span class="d-block d-sm-none"><i class="fa fa-graduation-cap"></i></span>
                                <span class="d-none d-sm-block">Education</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 4])); ?>" class="nav-link border-none <?php echo e($tab == 4 ? 'active' : ''); ?>" title="Training" role="tab">
                                <span class="d-block d-sm-none"><i class="fa fa-chalkboard-teacher"></i></span>
                                <span class="d-none d-sm-block">Training</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 5])); ?>" class="nav-link border-none <?php echo e($tab == 5 ? 'active' : ''); ?>" title="Experience" role="tab">
                                <span class="d-block d-sm-none"><i class="fa fa-toolbox"></i></span>
                                <span class="d-none d-sm-block">Experience</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 6])); ?>" class="nav-link border-none <?php echo e($tab == 6 ? 'active' : ''); ?>" title="Service" role="tab">
                                <span class="d-block d-sm-none"><i class="fa fa-briefcase"></i></span>
                                <span class="d-none d-sm-block">Service</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 7])); ?>" class="nav-link border-none <?php echo e($tab == 7 ? 'active' : ''); ?>" title="Reference" role="tab">
                                <span class="d-block d-sm-none"><i class="far fa-address-card"></i></span>
                                <span class="d-none d-sm-block">Reference</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 8])); ?>" class="nav-link border-none <?php echo e($tab == 8 ? 'active' : ''); ?>" title="Documents" role="tab">
                                <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                <span class="d-none d-sm-block">Documents</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 9])); ?>" class="nav-link border-none <?php echo e($tab == 9 ? 'active' : ''); ?>" title="Mescellaneous" role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-tools"></i></span>
                                <span class="d-none d-sm-block">Mescellaneous</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('hris.database.employee.show', ['employee' => $employee->id,'tab' => 10])); ?>" class="nav-link border-none <?php echo e($tab == 10 ? 'active' : ''); ?>" title="Bangla" role="tab">
