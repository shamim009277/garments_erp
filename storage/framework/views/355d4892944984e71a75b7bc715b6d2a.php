    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'INVENTORY',
                'subtitle' => 'Delivery Normal',
                'breadcrumbs' => [
                    ['label' => 'INVENTORY', 'url' => route('inventory.index')],
                    ['label' => 'Database', 'url' => route('inventory.index')],
                    ['label' => 'Delivery Normal', 'url' => route('inventory.database.normaldelivery.index')],
                ],
            ...
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="my-0 text-primary ms-2">Delivery Normal List</h6>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center">
                                        <i data-feather="list" width="16" height="16"></i> 
                                        <h6 class="my-0 text-primary ms-2"> Input Parameters For Delivery Normal..</h6>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form id="addFormMain" action="<?php echo e(route('inventory.database.normaldeliverymains.store')); ?>" method="POST">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-search-input','data' => ['id' => 'required_by_id','name' => 'required_by_id','options' => $users->pluck('name', 'id'),'selected' => old('required_by'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'required_by_id','name' => 'required_by_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($users->pluck('name', 'id')),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('required_by')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/normaldeliverymains')); ?>/"+id,
            ...
            $('#addFormMain').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('inventory.database.normaldeliverymains.store')); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/normaldeliverymains/multiplestatus')); ?>/"+req_id,
                    data: {
                        is_done: 1,
            ...
            $(document).on('click', '#deleteBtn', function(e) {
                ...
                if(purMainId == null || purMainId == undefined || purMainId == ''){
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(url('inventory/database/normaldeliverymains')); ?>/'+purMainId,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: purMainId
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.normaldeliverymains.search')); ?>",
                    data: {
                        search: search,
                        match: match,
                        _token: "<?php echo e(csrf_token()); ?>"
            ...
            $('#search_data').on('select2:select', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('inventory.database.normaldeliverydetails.store')); ?>",
                    data: {
                        item_id: itemId,
                        req_no: req_no,
                        _token: "<?php echo e(csrf_token()); ?>"
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/normaldeliverydetails')); ?>/"+id,
                    data: {
                        req_qty: reqQty,
                        for_qty: reqQty,
                        app_qty: reqQty,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\normaldelivery\index.blade.php ENDPATH**/ ?>