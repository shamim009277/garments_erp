    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'INVENTORY',
                'subtitle' => 'Gate Out Challan Gate',
                'breadcrumbs' => [
            ...
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="my-0 text-primary ms-2">Gate Out Challan Gate List</h6>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            function getChallanMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/gateoutchallangate')); ?>/"+id,
                        ...
                        $.each(detailsData, function(key, value) {
                            $('#item-row').append(`
                                <tr id="item-row-${value.id}">
                                    ...
                                    <td width="10%">${value.unit.name}</td>
                                    <td width="10%">${value.challan_qty?value.challan_qty:0}</td>
                                    <td>
                                    N/A
                                    </td>
                                </tr>
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    ...
                    data: {
                        is_gate_out: 1,
                        gate_out_by_id: "<?php echo e(Auth::user()->id); ?>",
                        gate_out_date: "<?php echo e(date('Y-m-d')); ?>",
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.gateoutchallangate.search')); ?>",
                    data: {
                        search: search,
                        match: match,
                        _token: "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\gateoutchallanagate\index.blade.php ENDPATH**/ ?>