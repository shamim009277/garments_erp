    ...
    <div class="row">
        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                ...
                <form id="employeeListingForm" action="<?php echo e(route('payroll.report.salary-report.report.preview')); ?>" method="POST" target="_blank">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <!-- Titles -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Payroll\resources\views\report\salary\index.blade.php ENDPATH**/ ?>