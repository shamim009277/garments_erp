    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'INVENTORY',
                'subtitle' => 'Internal Requisition Delivery',
                'breadcrumbs' => [
                    ['label' => 'INVENTORY', 'url' => route('inventory.index')],
                    ['label' => 'Database', 'url' => route('inventory.index')],
                    ['label' => 'Internal Requisition Delivery', 'url' => route('inventory.database.intreqdelidary.index')],
                ],
        ...
        $(document).ready(function() {
            ...
            $("#done-btn").click(function() {
                ...
                if(validateItem()){
                    ...
                    $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/intreqdelidary/multiplestatus')); ?>/"+req_id,
                    data: {
                        is_forward: 1,
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.intreqdelidary.search')); ?>",
                    data: {
                        search: search,
                        match: match,
                        _token: "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\intreqforwarding\index.blade.php ENDPATH**/ ?>