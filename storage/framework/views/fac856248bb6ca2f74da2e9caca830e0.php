                                    ...
                                    <td width="60%" style="border: none;">
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="checkbox" style="display: inline-block;" name="document_id[]" id="document_id" value="<?php echo e($document->id); ?>" <?php echo e($checked); ?>>
                                                <label class="form-check-label" for="document_id"><?php echo e($document->name); ?></label>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                </tr>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\new erp\garments_erp\Modules\HRIS\resources\views\database\employee\tab8.blade.php ENDPATH**/ ?>