    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#displayBtn', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('payroll.tools.edit-attendence.store')); ?>',
                    type: 'POST',
                    data: {
        ...
        function updateAttendence(id) {
            ...
            $.ajax({
                url: '<?php echo e(route('payroll.tools.edit-attendence.update', ':id')); ?>'.replace(':id', id),
                type: 'PUT',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Payroll\resources\views\tools\edit-attendence\index.blade.php ENDPATH**/ ?>