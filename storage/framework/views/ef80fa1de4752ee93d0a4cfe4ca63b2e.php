                                ...
                                <tbody id="increment_enforce_table_body">
                                     <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="row-<?php echo e($data->id); ?>">
                                            <td>
                                                <input type="checkbox" class="form-check-input employee" name="employee_ids[]" value="<?php echo e($data->id); ?>">
    ...
    $(document).on('click', '#discardBtn', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo e(route('hris.database.increment-enforce.store')); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\HRIS\resources\views\database\incrementenforce\index.blade.php ENDPATH**/ ?>