                        ...
                        <?php $__currentLoopData = $uniqueDesignations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($employee->designation_id == $designation->id): ?>
                                <tr>
                                    ...
                                    <td><?php echo e(optional($employee->applicant)->entry_date ? date('d-m-Y', strtotime($employee->applicant->entry_date)) : 'N/A'); ?></td>
...
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\Modules/HRIS\resources/views/report/applicant/pdf.blade.php ENDPATH**/ ?>