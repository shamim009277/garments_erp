...
<?php if($messages): ?>
    <?php $__currentLoopData = (array) $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div <?php echo e($attributes->merge(['class' => 'text-danger mb-1'])); ?>>
            <?php echo e($message); ?>

        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\resources\views/components/input-error.blade.php ENDPATH**/ ?>