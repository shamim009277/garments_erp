        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    <?php if($title == 1): ?>
                        <h6 class="my-0 text-primary text-center">Department-wise Date Range Applicant of Employees</h6>
                    <?php elseif($title == 2): ?>
                        <h6 class="my-0 text-primary text-center">Designation-wise Date Range Applicant of Employees</h6>
                    <?php elseif($title == 3): ?>
                        <h6 class="my-0 text-primary text-center">Daily Applicant Joined Within Date Range</h6>
                    <?php elseif($title == 4): ?>
                        <h6 class="my-0 text-primary text-center">Daily Applicant With Blood Group</h6>
                    <?php endif; ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($employee->joining_date ? date('d-m-Y', strtotime($employee->joining_date )) : 'N/A'); ?></td>
                                        <td><?php echo e($employee->entry_date ? date('d-m-Y', strtotime($employee->entry_date )) : 'N/A'); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\Modules/HRIS\resources/views/report/applicant/preview.blade.php ENDPATH**/ ?>