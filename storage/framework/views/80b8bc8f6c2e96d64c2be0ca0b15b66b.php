                                ...
                                <tr id="row-<?php echo e($buyer->id); ?>">
                                    ...
                                    <td class="text-center">
                                        <div class="square-switch">
                                            <input type="checkbox" id="buyer-switch-<?php echo e($buyer->id); ?>"
                                                class="buyer-toggle" data-id="<?php echo e($buyer->id); ?>"
                                                switch="bool" <?php echo e($buyer->is_active ? 'checked' : ''); ?> />
                                            <label for="buyer-switch-<?php echo e($buyer->id); ?>" data-on-label="Yes"
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-soft-danger waves-effect waves-light delete-buyer"
                                            data-id="<?php echo e($buyer->id); ?>" style="padding: 4px 6px;"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="<?php echo e(route('ordermanagement.setup.buyers.update', $buyer->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input-group','data' => ['name' => 'buyer_type','label' => 'Buyer Type','options' => ['Local', 'Foreign', 'Both', 'Buying House', 'Retail', 'Online Seller'],'selected' => collect(['Local', 'Foreign', 'Both', 'Buying House', 'Retail', 'Online Seller'])->search($buyer->buyer_type)??old('buyer_type'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'buyer_type','label' => 'Buyer Type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Local', 'Foreign', 'Both', 'Buying House', 'Retail', 'Online Seller']),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(collect(['Local', 'Foreign', 'Both', 'Buying House', 'Retail', 'Online Seller'])->search($buyer->buyer_type)??old('buyer_type')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).on('change', '.buyer-toggle', function() {
            ...
            $.ajax({
                url: '<?php echo e(route('ordermanagement.setup.buyers.toggle')); ?>',
                type: 'POST',
                data: {
                    id: id,
                    status: status,
        ...
        $(document).on('click', '.delete-buyer', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('ordermanagement.setup.buyers.destroy', ':id')); ?>'.replace(':id', id),
                        type: 'DELETE',
                        data: {
                            _token: '<?php echo e(csrf_token()); ?>',
                        },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules/OrderManagement\resources/views/setup/buyers/index.blade.php ENDPATH**/ ?>