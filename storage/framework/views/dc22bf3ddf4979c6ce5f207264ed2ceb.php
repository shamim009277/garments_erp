...
<body>
    ...
    <?php elseif($title == 2): ?>
        ...
        <table class="info-table font-body">
            ...
            <tr>
                <td>জন্ম তারিখ : <?php echo e(bnNumber(date('d-m-Y', strtotime($employee->birth_date ?? '---------')))); ?>
...
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\Modules/HRIS\resources/views/report/autogenerationreport/pdf.blade.php ENDPATH**/ ?>