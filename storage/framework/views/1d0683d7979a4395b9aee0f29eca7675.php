        ...
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                ...
                'breadcrumbs' => [
                    ...
                    ['label' => 'Fabric Types', 'url' => route('inventory.setup.fabictypes.index')],
                ],
                        ...
                        <tbody>
                            <?php $__currentLoopData = $fabictypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fabictype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($fabictype->is_active ? 'Active' : 'Inactive'); ?></td>
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('inventory.setup.fabictypes.destroy', $fabictype->id)); ?>"
                                            method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            
                                            <button type="submit" class="btn btn-sm btn-danger"
                                                onclick="return confirm('Are you sure you want to delete this fabric type?')">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="<?php echo e(route('inventory.setup.fabictypes.update', $fabictype->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div class="col-md-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="<?php echo e(route('inventory.setup.fabictypes.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\setup\fabictypes\index.blade.php ENDPATH**/ ?>