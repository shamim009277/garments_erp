...
<body>
    ...
    <!-- PDF Body -->
    <?php if($title == 1): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Department-wise Increment</h3>
    <?php endif; ?>
    <?php if($title == 2): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Designation-wise Increment</h3>
    <?php endif; ?>
    <?php if($title == 3): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Department-wise Increment (New)</h3>
    <?php endif; ?>
    <?php if($title == 4): ?>
...
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\Modules/HRIS\resources/views/report/increment/pdf.blade.php ENDPATH**/ ?>