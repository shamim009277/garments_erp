...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        /* Adjust table cells for these inputs */
        td input.start_date,
        td input.end_date {
                                    ...
                                    <?php $__currentLoopData = $leaveApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveApplication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="white-space: nowrap;">
                                                ...
                                                <a href="<?php echo e(route('hris.database.leave-forward.show', $leaveApplication->id)); ?>" style="font-weight: bold; white-space: nowrap;">
                                            ...
                                            <td style="white-space: nowrap;">
                                                <input type="text" id="start_date<?php echo e($leaveApplication->form_id); ?>" class="form-control form-control-sm start_date" name="start_date[]" value="<?php echo e($leaveApplication->start_date); ?>" <?php echo e($leaveApplication->is_writable ? '' : 'readonly'); ?>>
                                            </td>

                                            <td style="white-space: nowrap;">
                                                <input type="text" id="end_date<?php echo e($leaveApplication->form_id); ?>" class="form-control form-control-sm end_date" name="end_date[]" value="<?php echo e($leaveApplication->end_date); ?>" <?php echo e($leaveApplication->is_writable ? '' : 'readonly'); ?>>
                                            </td>

                                            <td style="text-align: center; white-space: nowrap;">
                                                <input type="text" id="days<?php echo e($leaveApplication->form_id); ?>" class="form-control form-control-sm days" name="days[]" value="<?php echo e($leaveApplication->days); ?>" <?php echo e($leaveApplication->is_writable ? '' : 'readonly'); ?> style="text-align: center;">
                                            </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\HRIS\resources\views\database\leaveforward\index.blade.php ENDPATH**/ ?>