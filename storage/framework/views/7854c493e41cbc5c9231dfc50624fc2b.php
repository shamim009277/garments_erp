...
<body>
    ...
    <table> 
        ...
        <?php $__currentLoopData = $reqDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td style="text-align: center;"><?php echo e(@$x->final_app_qty); ?></td>
    ...
    <footer>
        <table style="width: 100%;">
            ...
            <tr>
                <td style="text-align: center;padding: 5px;"><?php echo e($purrequisition->forward_by->name ?? 'N/A'); ?> <br><?php echo e($purrequisition->forward_date ?? 'N/A'); ?></td>
                <td style="text-align: center;padding: 5px;"><?php echo e($purrequisition->priced_by->name ?? 'N/A'); ?> <br><?php echo e($purrequisition->priced_date ?? 'N/A'); ?></td>
                <td style="text-align: center;padding: 5px;"><?php echo e($purrequisition->confirmed_by->name ?? 'N/A'); ?> <br><?php echo e($purrequisition->confirmed_date ?? 'N/A'); ?></td>
                <td style="text-align: center;padding: 5px;"><?php echo e($purrequisition->approved_by->name ?? 'N/A'); ?> <br><?php echo e($purrequisition->approved_date ?? 'N/A'); ?></td>
                <td style="text-align: center;padding: 5px;"><?php echo e($purrequisition->fapproved_by->name ?? 'N/A'); ?> <br><?php echo e($purrequisition->fapproved_date ?? 'N/A'); ?></td>
            </tr>
        </table>
...
<?php /**PATH C:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\purreqpending\pdf.blade.php ENDPATH**/ ?>