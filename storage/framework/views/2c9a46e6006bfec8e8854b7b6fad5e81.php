    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'INVENTORY',
                'subtitle' => 'Requisition (Pending)',
                'breadcrumbs' => [
                    ['label' => 'INVENTORY', 'url' => route('inventory.index')],
                    ['label' => 'Database', 'url' => route('inventory.index')],
                    ['label' => 'Requisition (Pending)', 'url' => route('inventory.database.purreqpending.index')],
                ],
    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/purreqpending')); ?>/"+id,
                    success: function(data) {
                        console.log(data);
            ...
            function searchRequisition(search) {
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.purreqpending.search')); ?>",
                    data: {
                        search: search,
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\purreqpending\index.blade.php ENDPATH**/ ?>