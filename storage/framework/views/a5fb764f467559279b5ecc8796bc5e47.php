    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'HRIS',
                'subtitle' => 'Employee Gate Pass In',
                'breadcrumbs' => [
                    ['label' => 'HRIS', 'url' => route('hris.index')],
                    ['label' => 'Database', 'url' => route('hris.index')],
                    ['label' => 'Employee Gate Pass In', 'url' => route('hris.database.employee-gatepass.in')],
                ],
            ...
            <form action="<?php echo e(route('hris.database.employee-gatepass.store')); ?>" method="POST">
                ...
                <div class="card alert-primary alert-top-border padding-card">
                    <div class="card-header">
                        <h6 class="my-0 text-primary"> <i data-feather="list" width="18" height="18"></i> Employee Gate Pass In</h6>
                    </div>
                    <div class="card-body">
                        <table id="datacom" class="table table-striped" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr id="row-<?php echo e($gatePass->id); ?>">
                                    ...
                                    <td><?php echo e($gatePass->approvedBy->name ?? 'N/A'); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" onclick="inBtn(<?php echo e($gatePass->id); ?>)">
                                            <i data-feather="log-in" width="16" height="16"></i> In</button>
                                    </td>
                                </tr>
...
<script>
    ...
    function inBtn(id) {
        $.ajax({
            url: '<?php echo e(route('hris.database.employee-gatepass.in')); ?>',
            type: 'POST',
            data: {
            ...
            success: function (response) {
                if (response) {
                    Swal.fire(
                        'Success!',
                        'Employee gate pass in successfully.',
                        'success'
                    );
                    $('#row-' + id).remove();
                }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\HRIS\resources\views\database\gatepass\in.blade.php ENDPATH**/ ?>