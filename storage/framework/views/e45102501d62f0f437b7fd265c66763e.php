    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'Payroll',
                'subtitle' => 'Process Salary',
                'breadcrumbs' => [
                    ['label' => 'Payroll', 'url' => route('payroll.index')],
                    ['label' => 'Tools', 'url' => route('payroll.index')],
                    ['label' => 'Process Salary', 'url' => route('payroll.tools.process-salary.index')],
                ],
        ...
        <div class="col-lg-6 ps-lg-0" style="margin:0px auto;">
            <form action="<?php echo e(route('payroll.tools.process-salary.store')); ?>" id="applicantForm" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card alert-primary alert-top-border">
                    <div class="card-header" style="padding: 15px 16px;">
                        <h6 class="my-0 text-primary"> <i data-feather="list" width="16" height="16"></i> Process Salary</h6>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="title1">Process Salary</label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="title" value="2" id="title2">
                                    <label class="form-check-label" for="title2">Undo / Revert Process Salary</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="title" value="3" id="title3">
                                    <label class="form-check-label" for="title3">Confirm Process Salary</label>
                                </div>
                            </div><br><br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\Modules/Payroll\resources/views/tools/processsalary/index.blade.php ENDPATH**/ ?>