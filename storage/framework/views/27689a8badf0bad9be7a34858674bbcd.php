...
<?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="60%" id="category_section">
                                            <input type="text" name="house_rent_basic" id="house_rent_basic" class="form-control form-control-sm" value="<?php echo e((int)$hroption->house_rant_percent_basic); ?>"  placeholder="House Rant % Basic" required readonly/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="40%">
