                ...
                <ul class="nav-custom">
                    <li class="nav-custom-item">
                        ...
                        <ul class="nav-custom-content">
                            ...
                            <li class="nav-custom-item"><a href="<?php echo e(route('sms.database.sampleorderprogramme.show', $order->id)); ?>" class="nav-custom-link"><?php echo e($order->order_code); ?></a></li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aandg/public_html/Modules/SM/resources/views/database/sampleorderprogramme/index.blade.php ENDPATH**/ ?>