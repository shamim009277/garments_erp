    ...
    <div class="row">
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                'title' => 'INVENTORY',
                'subtitle' => 'Requisition (Complete)',
                'breadcrumbs' => [
                    ['label' => 'INVENTORY', 'url' => route('inventory.index')],
                    ['label' => 'Database', 'url' => route('inventory.index')],
                    ['label' => 'Requisition (Complete)', 'url' => route('inventory.database.purreqcompleted.index')],
                ],
    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/purreqcompleted')); ?>/"+id,
                    success: function(data) {
                        console.log(data);
                        ...
                        // $('#printBtn').attr('href', '<?php echo e(url('inventory/database/purreqpending/pdf')); ?>/'+id);
            ...
            function searchRequisition(search) {
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.purreqcompleted.search')); ?>",
                    data: {
                        search: search,
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\purreqcomplete\index.blade.php ENDPATH**/ ?>