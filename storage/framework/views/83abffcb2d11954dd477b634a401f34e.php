...
<body>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <img src="<?php echo e($logo); ?>" width="50" height="50" alt="Logo">
                                    </td>
                                    <!-- Gap -->
                                    <td style="width: 10px;"></td>
                                    <!-- Company Info -->
                                    <td style="text-align: center; line-height: 1.0;">
                                        <div class="company-name"><?php echo e($orgname); ?></div>
                                        <div class="company-address"><?php echo e($address); ?></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <?php if($title == 1): ?>
        ...
        <table>
            <tr>
                <td>তারিখ: <?php echo e(bnNumber(date('d-m-Y'))); ?></td>
            </tr>
        </table>
        </div>
        <?php if(!empty($employee)): ?>
            ...
            <div class="content">
                ...
                <p class="font-body">
                    জনাব,<br>
                    আমি - <?php echo e($employee->name_bangla ?? '................................'); ?> <br>
                    পিতা - <?php echo e($employee->fname_bangla ?? '................................'); ?> <br>
                    গ্রাম - <?php echo e($employee->mvillage_bangla ?? '................................'); ?> <br>
                    ডাকঘর - <?php echo e($employee->mpost_office_bangla ?? '................................'); ?> <br>
                    উপজেলা - <?php echo e($employee->thana_name ?? '................................'); ?> <br>
                    জেলা - <?php echo e($employee->district_name ?? '................................'); ?> <br><br>

                    নিয়োগ পত্রের সকল শর্ত মেনে নিয়ে আজকের তারিখ হতে চাকরিতে যোগদান করিলাম।
                </p>
                <p class="font-body">তারিখঃ
                    <?php echo e(bnNumber(date('d-m-Y', strtotime($employee->joining_date ?? '................................')))); ?>
    ...
    <?php elseif($title == 2): ?>
        ...
        <table class="info-table font-body">
            <tr>
                <td>নাম : <?php echo e($employee->name_bangla); ?></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>পিতার নাম : <?php echo e($employee->fname_bangla); ?></td>
                <td>মাতার নাম : <?php echo e($employee->mname_bangla ?? '---------'); ?> </td>
                <td></td>
            </tr>
            <tr>
                <td>স্বামী/স্ত্রীর নাম : <?php echo e($employee->relation_bangla ?? '---------'); ?> </td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>বর্তমান ঠিকানা : গ্রাম : <?php echo e($employee->pvillage_bangla); ?> থানা : <?php echo e($employee->thana_name_p); ?>

                    <br> &emsp;&emsp;&emsp;&emsp; ডাকঘর :<?php echo e($employee->ppost_office_bangla); ?> জেলা :
                    <?php echo e($employee->district_name_p); ?>
            ...
            <tr>
                <td>স্থায়ী ঠিকানা : গ্রাম : <?php echo e($employee->mvillage_bangla); ?> থানা : <?php echo e($employee->thana_name); ?>

                    <br>
                    &emsp;&emsp;&emsp;&emsp; ডাকঘর :<?php echo e($employee->mpost_office_bangla); ?> জেলা :
                    <?php echo e($employee->district_name); ?>
            ...
            <tr>
                <td>জাতীয় পরিচয়পত্র নং : <?php echo e($employee->national_id ?? '---------'); ?> </td>
                <td>জন্ম নিবন্ধনপত্র নং : <?php echo e($employee->birth_certificate ?? '---------'); ?></td>
                <td></td>
            </tr>
            <tr>
                <td>সনাক্তকরণ চিহ্ন(যদি থাকে) : <?php echo e($employee->identification ?? '---------'); ?> </td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>জন্ম তারিখ : 
                    <?php echo e(($employee->birth_date && $employee->birth_date != '0000-00-00') ? bnNumber(date('d-m-Y', strtotime($employee->birth_date))) : '---------'); ?>

                </td>
                <td> কাজে যোগদানের তারিখ :
                    <?php echo e($employee->joining_date ? bnNumber(date('d-m-Y', strtotime($employee->joining_date))) : '---------'); ?>

                </td>
                <td></td>
            </tr>
            <tr>
                <td>আপনার আবেদনের প্রেক্ষিতে আপনাকে <?php echo e($employee->designation_name ?? '---------'); ?> পদে </td>
                <td>নিয়োগ করা হইলো। গ্রেড নং <?php echo e($employee->grade ?? '---------'); ?></td>
                <td></td>
            </tr>
            <tr>
                <td>আপনার কার্ড নং : <?php echo e(bnNumber($employee->emp_id ?? '---------')); ?></td>
                <td></td>
                <td></td>
            </tr>
        </table>
        ...
        <table width="80%" class="info-table hanging">
            <tr>
                <td>(ক) মূল বেতন :</td>
                <td><?php echo e(bnNumber(number_format($employee->basic, 2))); ?> টাকা</td>
            </tr>
            <tr>
                <td>(খ) বাড়িভাড়া (মূল বেতনের ৫০%) :</td>
                <td><?php echo e(bnNumber(number_format($employee->basic * 0.5, 2))); ?> টাকা</td>
            </tr>
            <tr>
                <td>(গ) চিকিৎসা ভাতা :</td>
                <td><?php echo e(bnNumber(number_format($employee->medical_allowance, 2))); ?> টাকা</td>
            </tr>
            <tr>
                <td>(ঘ) যাতায়াত ভাতা :</td>
                <td><?php echo e(bnNumber(number_format($employee->conveyance, 2))); ?> টাকা</td>
            </tr>
            <tr>
                <td>(ঙ) খাবার ভাতা :</td>
                <td><?php echo e(bnNumber(number_format($employee->food_allowance, 2))); ?> টাকা</td>
            </tr>
            <tr>
                <td class="font-body underline">মোট বেতন : </td>
                <td class="font-body underline">
                    <?php echo e(bnNumber(number_format($employee->basic + $employee->home_allowance + $employee->medical_allowance + $employee->food_allowance + $employee->conveyance, 2))); ?>
        ...
        <table width="100%" class="info-table hanging">
            ...
            <tr>
                <td> </td>
                <td>আমি <?php echo e($employee->name_bangla); ?> স্বজ্ঞানে ও স্বেচ্ছায় এই নিয়োগ পত্রের সকল শর্ত মেনে ও বুঝে
                    ...
                    <?php if(!empty($employee)): ?>
                        ...
                        <table class="info-table">
                            <tr>
                                ...
                                <td class="value">: <?php echo e($employee->name_bangla); ?></td>
                                <td class="label" style="text-align: right">লিঙ্গ</td>
                                <td class="value">: <?php if($employee->sex_code == 'M'): ?>
                                        পুরুষ
                                    <?php else: ?>
                                        মহিলা
                                    <?php endif; ?>
                            ...
                            <tr>
                                <td></td>
                                <td> গ্রাম : <?php echo e($employee->pvillage_bangla); ?></td>
                                <td>ডাকঘর : <?php echo e($employee->ppost_office_bangla); ?></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td> থানা : <?php echo e($employee->thana_name_p); ?></td>
                                <td>জেলা : <?php echo e($employee->district_name_p); ?></td>
                            </tr>

                            <tr>
                                <td>২। পিতার নাম</td>
                                <td>: <?php echo e($employee->fname_bangla); ?></td>
                                <td>৩। স্বামী/স্ত্রীর নাম</td>
                                <td>: <?php echo e($employee->relation_bangla); ?></td>
                            </tr>
                            <tr>
                                <td>৪। মাতার নাম</td>
                                <td>: <?php echo e($employee->mname_bangla); ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td>৫। জন্ম তারিখ</td>
                                <td>:
                                    <?php echo e($employee->birth_date ? bnNumber(date('d-m-y', strtotime($employee->birth_date))) : '---------'); ?>

                                </td>
                                <td>বয়স</td>
                                <td>: <?php echo e($ageFull); ?></td>
                            </tr>
                            <tr>
                                <td>৬। সনাক্তকরণ চিহ্ন(যদি থাকে)</td>
                                <td>: <?php echo e($employee->identification ?? '---------'); ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>৭। স্থায়ী ঠিকানা</td>
                                <td> গ্রাম : <?php echo e($employee->mvillage_bangla); ?></td>
                                <td>ডাকঘর : <?php echo e($employee->mpost_office_bangla); ?></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td> থানা : <?php echo e($employee->thana_name); ?></td>
                                <td>জেলা : <?php echo e($employee->district_name); ?></td>
                            </tr>

                            <tr>
                                <td>৮। মোবাইল নম্বর</td>
                                <td>: <?php echo e($employee->mobile ?? '01XXXXXXXXX'); ?></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                        ...
                        <div class="declaration">
                            আমি <?php echo e($employee->name_bangla); ?> এতদ্বারা ঘোষনা করিতেছি যে, আমার মৃত্যু হইলে বা আমার
                            অবর্তমানে, আমার
                        ...
                        <table class="nominee-table info-table">
                            ...
                            <tr>
                                <td class="font-bold">
                                    নমিনির নাম : <?php echo e($employee->nname_bangla); ?> <br>
                                    পিতা/স্বামী : <?php echo e($employee->name_bangla); ?> <br>
                                    গ্রাম : <?php echo e($employee->nvillage_bangla); ?> <br>
                                    পোষ্ট : <?php echo e($employee->npost_office_bangla); ?> <br>
                                    থানা : <?php echo e($employee->thana_name_n); ?> <br>
                                    জেলা : <?php echo e($employee->district_name_n); ?><br>
                                    এন আইডি : <?php echo e($employee->national_id); ?> <br>
                                    মোবাইল : <?php echo e($employee->nmobile_number); ?>

                                </td>
                                <td align="center"><?php echo e($employee->nominee_relation ?? 'N/A'); ?></td>
                        ...
                        <table class="info-table">
                            <tr>
                                ...
                                <td>: <?php echo e($employee->nname_bangla ?? ''); ?></td>
                                <td></td>
                ...
                <?php elseif($title == 4): ?>
                    <?php if(!empty($employee)): ?>
                        <table width="100%" style="margin-bottom: 10px;">
                            <tr>
                                ...
                                <td style="width: 80px; text-align: right; vertical-align: middle;">
                                    <img src="<?php echo e(public_path('backend/assets/images/logo-sm.svg')); ?>" width="120"
                                        height="80" alt="Logo">
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="nominee-table info-table">
                            ...
                            <tr>
                                <td>১. ক্রমিক নং : <?php echo e($employee->employee_id); ?></td>
                                <td>১. ক্রমিক নং : <?php echo e($employee->employee_id); ?></td>
                            </tr>
                            <tr>
                                <td>তারিখ :
                            ...
                            <tr>
                                <td>২। নাম : <?php echo e($employee->name_bangla); ?></td>
                                <td rowspan="3">আমি এই মর্মে প্রত্যয়ন করিতেছি যে,<br>
                                    নাম : <?php echo e($employee->name_bangla); ?> <br>
                                    পিতার নাম : <?php echo e($employee->fname_bangla); ?><br>
                                    মাতার নাম : <?php echo e($employee->mname_bangla); ?><br>
                                    ঠিকানা : <?php echo e($employee->mvillage_bangla); ?> <br>
                                    কে আমি পরীক্ষা করিয়াছি।
                                </td>
                            </tr>
                            <tr>
                                <td>3। পিতার নাম : <?php echo e($employee->fname_bangla); ?></td>

                            </tr>
                            <tr>
                                <td>৪। মাতার নাম : <?php echo e($employee->mname_bangla); ?></td>

                            </tr>
                            <tr>
                                <td>৫। লিঙ্গ : <?php if($employee->sex_code == 'M'): ?>
                                        পুরুষ
                                    <?php else: ?>
                                        মহিলা
                                    <?php endif; ?>
                            ...
                            <tr>
                                <td>৬। স্থায়ী/যোগাযোগের ঠিকানা : <br>
                                    গ্রাম : <?php echo e($employee->mvillage_bangla); ?> <br>
                                    পোষ্ট : <?php echo e($employee->mpost_office_bangla); ?> <br>
                                    থানা : <?php echo e($employee->thana_name); ?> <br>
                                    জেলা : <?php echo e($employee->district_name); ?><br>
                                </td>
                            ...
                            <tr>
                                <td>৭। অস্থায়ী/যোগাযোগের ঠিকানা : <br>
                                    গ্রাম : <?php echo e($employee->pvillage_bangla); ?> <br>
                                    পোষ্ট : <?php echo e($employee->ppost_office_bangla); ?> <br>
                                    থানা : <?php echo e($employee->thana_name_p); ?> <br>
                                    জেলা : <?php echo e($employee->district_name_p); ?><br></td>
                                <td> তাহার সনাক্তকরনের চিহ্ন :<?php echo e($employee->identification ?? '--'); ?> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>৯। দৈহিক সক্ষমতা : <?php echo e($employee->physical_capacity ?? ''); ?></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>১০। সনাক্তকরনের চিহ্ন : <?php echo e($employee->identification ?? '--'); ?></td>
                                <td></td>
                            </tr>
                        </table>
                ...
                <?php elseif($title == 5): ?>
                    <?php if(!empty($employee)): ?>
                        ...
                        <table width="100%" style="margin-bottom: 10px;">
                            <tr>
                                <td>নাম : <?php echo e($employee->name_bangla ?? ''); ?></td>
                                <td style="text-align: left">আইডি: <?php echo e($employee->employee_id ?? ''); ?></td>
                            </tr>
                            <tr>
                                <td>তারিখ:
                                    <?php echo e($employee->joining_date ? bnNumber(date('d-m-Y', strtotime($employee->joining_date))) : ''); ?>
                                ...
                                <td style="text-align: left">পদবী: <?php echo e($employee->designation_name ?? ''); ?></td>
                            </tr>
                        </table>
                        <table width="100%" style="margin-bottom: 10px;">
                            <tr>
                        ...
                        <table width="100%" style="margin-bottom: 10px;">
                            ...
                            <tr>
                                <td>নাম: <?php echo e($employee->name_bangla ?? ''); ?></td>
                                <td style="text-align: left">বয়স: <?php echo e($ageFull ?? ''); ?></td>
                            </tr>
                            <tr>
                                <td>পিতার নাম: <?php echo e($employee->fname_bangla ?? ''); ?></td>
                                <td style="text-align: left">পদবী: <?php echo e($employee->designation_name ?? ''); ?></td>
                        ...
                        <table width="100%" style="marge-bottom:10px;">
                            <tr>
                                <td>স্থায়ী/যোগাযোগের ঠিকানা : গ্রাম : <?php echo e($employee->mvillage_bangla); ?> </td>
                                <td> থানা : <?php echo e($employee->thana_name); ?></td>
                            </tr>
                            <tr>
                                <td>পোষ্ট : <?php echo e($employee->mpost_office_bangla); ?> </td>
                                <td> জেলা : <?php echo e($employee->district_name); ?></td>
                            </tr>
                        </table>
                        <br>
                        <table width="100%" style="marge-bottom:20px;">
                            <tr>
                                <td>অস্থায়ী/যোগাযোগের ঠিকানা : গ্রাম : <?php echo e($employee->pvillage_bangla); ?> </td>
                                <td>থানা : <?php echo e($employee->thana_name_p); ?></td>
                            </tr>
                            <tr>
                                <td>পোষ্ট : <?php echo e($employee->ppost_office_bangla); ?> </td>
                                <td> জেলা : <?php echo e($employee->district_name_p); ?></td>
                            </tr>
                        </table><br>
                        <table width="100%" style="marge-bottom:20px;">
                    ...
                    <?php endif; ?>
                <?php elseif($title == 6): ?>
                    <?php if($employeeChunk->count() > 0): ?>
                        <?php echo $__env->make('hris::report.autogenerationreport.salary-slip-pdf', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php else: ?>
                        <div style="text-align:center; font-size:14px; padding:30px;">
                            No pay slip found
                        </div>
...
<?php /**PATH H:\laragon\www\garments_erp\Modules\HRIS\resources\views\report\autogenerationreport\pdf.blade.php ENDPATH**/ ?>