                ...
                <div class="card-body p-4 p-sm-5">
                    <div class="text-center mb-4">
                        <a href="index.html" class="d-block auth-logo">
                            <img src="<?php echo e($general->logo_path ? Storage::url($general->logo_path) : asset('backend/assets/images/logo-sm.svg')); ?>" alt="Logo" height="40">
...
<?php endif; ?>
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\resources\views/auth/login.blade.php ENDPATH**/ ?>