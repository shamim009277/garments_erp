                            ...
                            <?php $__currentLoopData = $sizeGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sizeGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-<?php echo e($sizeGroup->is_active ? 'success' : 'danger'); ?>">
                                            <?php echo e($sizeGroup->is_active ? 'Active' : 'Inactive'); ?></p>
                                    </td>
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('inventory.setup.sizegroups.destroy', $sizeGroup->id)); ?>"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="<?php echo e(route('inventory.setup.sizegroups.update', $sizeGroup->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div class="col-md-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="<?php echo e(route('inventory.setup.sizegroups.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\setup\sizegroups\index.blade.php ENDPATH**/ ?>