                                    ...
                                    <div class="modal fade" id="editModal<?php echo e($sample->id); ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo e($sample->id); ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(route('ordermanagement.database.sampleorderprogramme.update', $sample->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="30%">
                                                                        <select name="color_id" class="form-control form-control-sm select2">
                                                                            <option value="">Select Color</option>
                                                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($color->id); ?>" <?php echo e($sample->color_id == $color->id ? 'selected' : ''); ?>><?php echo e($color->color_name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </td>
                                                                    ...
                                                                    <td width="30%">
                                                                        <select name="size_id" class="form-control form-control-sm select2">
                                                                            <option value="">Select Size</option>
                                                                            <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($size->id); ?>" <?php echo e($sample->size_id == $size->id ? 'selected' : ''); ?>><?php echo e($size->size_name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </td>
                                                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/aandg/public_html/Modules/OrderManagement/resources/views/database/sampleorderprogramme/show.blade.php ENDPATH**/ ?>