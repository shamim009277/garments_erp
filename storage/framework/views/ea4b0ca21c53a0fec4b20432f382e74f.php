...
<head>
    <meta charset="utf-8" />
    <title><?php echo e($general->short_name); ?> | <?php echo $__env->yieldContent('title', config('app.name')); ?></title>
    ...
    <?php if(isset($general) && $general->favicon_path): ?>
        <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(Storage::url($general->favicon_path)); ?>">
        <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(Storage::url($general->favicon_path)); ?>">
        <link rel="apple-touch-icon" href="<?php echo e(Storage::url($general->favicon_path)); ?>">
    <?php else: ?>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="<?php echo e(asset('backend/assets/images/android-chrome-192x192.png')); ?>">
        <link rel="icon" type="image/png" sizes="512x512" href="<?php echo e(asset('backend/assets/images/android-chrome-512x512.png')); ?>">
        <link rel="shortcut icon" href="<?php echo e(asset('backend/assets/images/favicon.ico')); ?>">
    <?php endif; ?>

    <link rel="manifest" href="<?php echo e(asset('backend/assets/images/site.webmanifest')); ?>">
    ...
    <link href="<?php echo e(asset('backend/assets/libs/admin-resources/rwd-table/rwd-table.min.css')); ?>" rel="stylesheet" type="text/css" />
    <!-- preloader css -->
...
<body data-sidebar-size='sm' data-topbar='dark'>
    ...
    <div id="layout-wrapper">
        ...
        <!-- ========== Left Sidebar Start ========== -->
        <?php if(request()->segment(1) != 'dashboard' && request()->segment(1) != 'user'): ?>
        ...
        <div class="main-content"
            style="<?php echo e(request()->segment(1) == 'dashboard' ? 'margin-left: 0px !important' : ''); ?>">
            <div class="page-content">
                <div class="container-fluid"
                    style="<?php echo e(request()->segment(1) == 'dashboard' ? 'padding: 0px !important' : ''); ?>">
                    <!-- start page title -->
    ...
    <!-- Right Sidebar -->
    <?php echo $__env->make('includes.right_bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- /Right-bar -->
    ...
    <!-- Responsive Table js -->
    <script src="<?php echo e(asset('backend/assets/libs/admin-resources/rwd-table/rwd-table.min.js')); ?>"></script>
    <!-- Init js -->
    <script src="<?php echo e(asset('backend/assets/js/pages/table-responsive.init.js')); ?>"></script>
...
<?php /**PATH E:\server2\htdocs\garments_erp\garments_erp\resources\views/layouts/app.blade.php ENDPATH**/ ?>