...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['name' => 'increment_type','id' => 'increment_type','class' => 'select2','options' => ['1' => 'Increment', '2' => 'Promotion', '3' => 'Increment & Promotion', '4' => 'Adjustment', '5' => 'Promotion & Adjustment', '6' => 'Designation Change', '7' => 'Reverse Amount'],'selected' => old('increment_type', '1'),'placeholder' => 'Select','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'increment_type','id' => 'increment_type','class' => 'select2','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['1' => 'Increment', '2' => 'Promotion', '3' => 'Increment & Promotion', '4' => 'Adjustment', '5' => 'Promotion & Adjustment', '6' => 'Designation Change', '7' => 'Reverse Amount']),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('increment_type', '1')),'placeholder' => 'Select','required' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'date','name' => 'increment_date','id' => 'increment_date','class' => 'form-control form-control-sm','value' => ''.e($lastMonthStart).'','placeholder' => 'Increment Date','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','name' => 'increment_date','id' => 'increment_date','class' => 'form-control form-control-sm','value' => ''.e($lastMonthStart).'','placeholder' => 'Increment Date','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td width="60%" id="category_section">
                                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'date','name' => 'effective_date','id' => 'effective_date','class' => 'form-control form-control-sm','value' => ''.e($lastMonthStart).'','placeholder' => 'Effective Date','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','name' => 'effective_date','id' => 'effective_date','class' => 'form-control form-control-sm','value' => ''.e($lastMonthStart).'','placeholder' => 'Effective Date','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td width="60%" id="category_section">
                                        <?php if (isset($component)) { $__componentOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['name' => 'increment_value','id' => 'increment_value','class' => 'select2','options' => ['P' => 'Percentage', 'F' => 'Flat'],'placeholder' => 'Increment Value','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'increment_value','id' => 'increment_value','class' => 'select2','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['P' => 'Percentage', 'F' => 'Flat']),'placeholder' => 'Increment Value','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36)): ?>
<?php $attributes = $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36; ?>
