    ...
    <script>
        $(document).ready(function() {
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/purreqstorercv')); ?>/"+id,
                    data: {
                        store_rcv_qty: store_rcv_qty,
                        pur_price: pur_price,
                        is_store_received: 1,
                        store_rcv_by: "<?php echo e(Auth::user()->id); ?>",
                        store_rcv_date: "<?php echo e($today_date); ?>",
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    ...
                    data: {
                        is_store_rcv: 1,
                        store_rcv_by: "<?php echo e(Auth::user()->id); ?>",
                        store_rcv_date: "<?php echo e(date('Y-m-d')); ?>",
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
                    success: function(data) {
                        console.log(data);
            ...
            function searchGatePurMrr(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.purreqstorercv.search')); ?>",
                    data: {
                        search: search,
                        match: match,
                        _token: "<?php echo e(csrf_token()); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\reqstorercv\index.blade.php ENDPATH**/ ?>