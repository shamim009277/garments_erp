                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" width="100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($purpose->id); ?>">
                                    <td><?php echo e($key + 1); ?></td>
                                    <td><?php echo e($purpose->purpose); ?></td>
                                    <td>
                                        <div class="square-switch">
                                            <input type="checkbox" id="square-switch3<?php echo e($purpose->id); ?>" class="purpose-toggle" data-id="<?php echo e($purpose->id); ?>" switch="bool" <?php echo e($purpose->is_active ? 'checked' : ''); ?> />
                                            <label for="square-switch3<?php echo e($purpose->id); ?>" data-on-label="Yes" data-off-label="No" style="margin: 0px; vertical-align: middle;"></label>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="#" class="btn btn-soft-success waves-effect waves-light" style="padding: 4px 6px;" data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($purpose->id); ?>"><i class="fas fa-edit"></i></a>
                                        <a href="#" class="btn btn-soft-danger waves-effect waves-light delete-purpose" data-id="<?php echo e($purpose->id); ?>" style="padding: 4px 6px;"><i class="fas fa-trash"></i></a>
                                    </td>
                                    <div id="editModal<?php echo e($purpose->id); ?>" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="editForm<?php echo e($purpose->id); ?>" action="<?php echo e(route('hris.setup.gatepass_purpose.update', $purpose->id)); ?>" method="POST">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'purpose','label' => 'Purpose','type' => 'text','placeholder' => 'Enter purpose','value' => $purpose->purpose,'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'purpose','label' => 'Purpose','type' => 'text','placeholder' => 'Enter purpose','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($purpose->purpose),'required' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input-group','data' => ['name' => 'is_active','label' => 'Is Active','options' => ['1' => 'Active', '0' => 'Inactive'],'selected' => $purpose->is_active,'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'is_active','label' => 'Is Active','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['1' => 'Active', '0' => 'Inactive']),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($purpose->is_active),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="<?php echo e(route('hris.setup.gatepass_purpose.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'purpose','label' => 'Purpose','type' => 'text','placeholder' => 'Enter purpose','value' => old('purpose'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'purpose','label' => 'Purpose','type' => 'text','placeholder' => 'Enter purpose','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('purpose')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
    ...
    <script>
        $(document).ready(function() {
            $('.purpose-toggle').on('change', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('hris.setup.gatepass_purpose.toggle')); ?>',
                    type: 'POST',
                    data: {
                        id: id,
                        status: status,
        ...
        $(document).on('click', '.delete-purpose', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('hris.setup.gatepass_purpose.delete')); ?>',
                        type: 'POST',
                        data: {
                            _token: '<?php echo e(csrf_token()); ?>',
                            id: purposeId
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\HRIS\resources\views\setup\purpose\index.blade.php ENDPATH**/ ?>