    ...
    <div class="row">
        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                ...
                <form id="employeeListingForm" action="<?php echo e(route('payroll.report.attendence-report.report.preview')); ?>" method="POST" target="_blank">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <!-- Titles -->
                                ...
                                <div class="card alert-info alert-top-border">
                                    ...
                                    <div class="card-body" style="max-height:400px;min-height:400px; overflow-y: auto;">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="title1">Department-wise Daily Attendance</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="title2" name="title" value="2"class="form-check-input titles">
                                            <label class="form-check-label" for="title2">Individual Card Wise Monthly Attendance</label>
                                        </div>
                                       </br><br>

                                       <div class="form-check">
                                            <input type="radio" id="title3" name="title" value="3"class="form-check-input titles">
                                            <label class="form-check-label" for="title3">Section Wise Daily Attendence Summary</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="title4" name="title" value="4"class="form-check-input titles">
                                            <label class="form-check-label" for="title4">Department Wise Daily Attendence Summary</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="title5" name="title" value="5"class="form-check-input titles">
                                            <label class="form-check-label" for="title5">Company Wise Daily Attendence Summary</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Payroll\resources\views\report\attendence\index.blade.php ENDPATH**/ ?>