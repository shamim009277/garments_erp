        ...
        <div class="col-12">
            <?php echo $__env->make('components.breadcrumb', [
                ...
                'breadcrumbs' => [
                    ...
                    ['label' => 'Return To Supplier', 'url' => route('inventory.database.returntosup.index')],
                ],
            ...
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="my-0 text-primary ms-2">Return To Supplier List</h6>
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center">
                                        <i data-feather="list" width="16" height="16"></i> 
                                        <h6 class="my-0 text-primary ms-2"> Input Parameters For Return To Supplier..</h6>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form id="addFormMain" action="<?php echo e(route('inventory.database.returntosupmains.store')); ?>" method="POST">
    ...
    <script>
        $(document).ready(function() {
            ...
            function getChallanMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/returntosupmains')); ?>/"+id,
                    success: function(data) {
                        ...
                        $('#printgtBtn').attr('href', "<?php echo e(url('inventory/database/returntosupmains/gtpdf')); ?>/"+id);
                        $('#printchBtn').attr('href', "<?php echo e(url('inventory/database/returntosupmains/chpdf')); ?>/"+id);
            ...
            $('#addFormMain').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('inventory.database.returntosupmains.store')); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/returntosupmains/multiplestatus')); ?>/"+challan_id,
                    data: {
                        is_done: 1,
            ...
            $(document).on('click', '#deleteBtn', function(e) {
                ...
                if(challanMainId == null || challanMainId == undefined || challanMainId == ''){
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(url('inventory/database/returntosupmains')); ?>/'+challanMainId,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: challanMainId
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.returntosupmains.search')); ?>",
                    data: {
                        search: search,
                        match: match,
                        _token: "<?php echo e(csrf_token()); ?>"
            ...
            $('#search_data').select2({
                    ...
                    ajax: {
                        type: 'PUT',
                        url: "<?php echo e(route('inventory.database.returntosup.search')); ?>",
                        dataType: 'json',
                        delay: 250,
                        cache: true,
            ...
            $('#search_data').on('select2:select', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('inventory.database.returntosupdetails.store')); ?>",
                    data: {
                        item_id: itemId,
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(url('inventory/database/returntosupdetails')); ?>/"+id,
                    data: {
                        unit_id: unit_id,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\returntosup\index.blade.php ENDPATH**/ ?>