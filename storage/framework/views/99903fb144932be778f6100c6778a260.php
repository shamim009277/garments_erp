...
<body>   
    ...
    <?php $__currentLoopData = $chunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <table style="width: 100%; margin-top: 20px;">
            <?php $__currentLoopData = $page->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                            ...
                            <table style="width: 100%; border: 1px solid #000; line-height: 1.2em; font-size: 12px;">
                                ...
                                <tr>
                                    <td colspan="2" style="text-align: center;">
                                        ...
                                        <span style="font-size: 13px;"> আয়েশা এন্ড গালিয়া ফ্যাশন্স লিমিটেড
                                    </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 100%; vertical-align: top;">
                                        ...
                                        <strong>আইডি কার্ড নং :-</strong> <?php echo e(str_pad($employee->employee_id, 6, '0', STR_PAD_LEFT)); ?><br>
                                        <strong>নাম :-</strong> <?php echo e($employee->name_bangla); ?><br>
                                        <strong>সেকশন/লাইন :-</strong> <?php echo e($employee->department->department_bn ?? '-'); ?><br>
                                        <strong>পদবী :-</strong> <?php echo e($employee->designation->designation_bn ?? '-'); ?><br>
                                        <strong>বেতন:-</strong> <?php echo e($employee->determined_salary ?? '-'); ?><br>
                                        <strong>যোগদানের তারিখ- :-</strong> <?php echo e(date('d-m-Y', strtotime($employee->joining_date))); ?>
...
</html><?php /**PATH C:\laragon\www\garments_erp\Modules\HRIS\resources\views\report\autogenerationreport\applicantpdf.blade.php ENDPATH**/ ?>