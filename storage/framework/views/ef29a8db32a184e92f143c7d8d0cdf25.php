...
<body>
    ...
    <!-- PDF Body -->
    <?php if($title == 1): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Department-wise Daily Shift</h3>
    <?php endif; ?>
    <?php if($title == 2): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Designation-wise Daily Shift</h3>
    <?php endif; ?>
    <?php if($title == 3): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Department-wise Monthly Shift</h3>
    <?php endif; ?>
    <?php if($title == 4): ?>
    <h3 style="text-align:center; margin: 20px 0px;">Designation-wise Monthly Shift</h3>
    <?php endif; ?>
...
<?php /**PATH D:\laragon\www\new erp\garments_erp\Modules\HRIS\resources\views\report\shift\pdf.blade.php ENDPATH**/ ?>