                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" width="100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $orderTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orderType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($orderType->id); ?>">
                                    <td width="5%"><?php echo e($key + 1); ?></td>
                                    <td width="70%"><?php echo e($orderType->order_type); ?></td>
                                    <td class="text-center">
                                        <div class="square-switch">
                                            <input type="checkbox" id="order-type-switch-<?php echo e($orderType->id); ?>"
                                                class="order-type-toggle" data-id="<?php echo e($orderType->id); ?>"
                                                switch="bool" <?php echo e($orderType->is_active ? 'checked' : ''); ?> />
                                            <label for="order-type-switch-<?php echo e($orderType->id); ?>"
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-soft-success waves-effect waves-light"
                                            ...
                                            data-bs-target="#editModal<?php echo e($orderType->id); ?>"><i class="fas fa-edit"></i></a>
                                        <a href="#" class="btn btn-soft-danger waves-effect waves-light delete-order-type"
                                            data-id="<?php echo e($orderType->id); ?>" style="padding: 4px 6px;"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                
                                <div class="modal fade" id="editModal<?php echo e($orderType->id); ?>" tabindex="-1"
                                    aria-labelledby="editModalLabel<?php echo e($orderType->id); ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel<?php echo e($orderType->id); ?>">Edit Order Type
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="<?php echo e(route('ordermanagement.setup.ordertypes.update', $orderType->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'order_type','label' => 'Order Type','placeholder' => 'Enter order type','value' => $orderType->order_type??old('order_type'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'order_type','label' => 'Order Type','placeholder' => 'Enter order type','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($orderType->order_type??old('order_type')),'required' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input-group','data' => ['name' => 'is_active','label' => 'Is Active?','options' => ['1' => 'Active', '0' => 'Inactive'],'selected' => $orderType->is_active ? '1' : '0','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'is_active','label' => 'Is Active?','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['1' => 'Active', '0' => 'Inactive']),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($orderType->is_active ? '1' : '0'),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="col-md-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="<?php echo e(route('ordermanagement.setup.ordertypes.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'order_type','label' => 'Order Type','placeholder' => 'Enter order type','value' => old('order_type'),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'order_type','label' => 'Order Type','placeholder' => 'Enter order type','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('order_type')),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
    ...
    <script>
        $(document).ready(function() {
            $('.order-type-toggle').on('change', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('ordermanagement.setup.ordertypes.toggle')); ?>',
                    type: 'POST',
                    data: {
                        id: id,
                        status: status,
            ...
            $(document).on('click', '.delete-order-type', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('ordermanagement.setup.ordertypes.delete')); ?>',
                            type: 'POST',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: id
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\OrderManagement\resources\views\setup\ordertypes\index.blade.php ENDPATH**/ ?>