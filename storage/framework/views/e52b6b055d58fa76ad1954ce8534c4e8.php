...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 ps-lg-1 ps-md-1" style="margin:0px auto;">
            <form action="<?php echo e(route('hris.tools.newshiftinglist.store')); ?>" id="applicantForm" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\HRIS\resources\views\tools\newshiftinglist\index.blade.php ENDPATH**/ ?>