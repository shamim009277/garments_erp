    ...
    <table> 
        ...
        <?php $__currentLoopData = $reqDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td style="text-align: center;"><?php echo e(@$x->remain_qty); ?></td>
...
<?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\purreqcomplete\pdf.blade.php ENDPATH**/ ?>