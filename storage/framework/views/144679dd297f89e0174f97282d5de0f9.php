    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('inventory/database/purreqpartial')); ?>/"+id,
                    success: function(data) {
                        console.log(data);
                        ...
                        $('#printBtn').attr('href', '<?php echo e(url('inventory/database/purreqpartial/pdf')); ?>/'+id);
            ...
            function searchRequisition(search) {
                $.ajax({
                    type: 'PUT',
                    url: "<?php echo e(route('inventory.database.purreqpartial.search')); ?>",
                    data: {
                        search: search,
                        _token: "<?php echo e(csrf_token()); ?>"
                    },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\purreqpartial\index.blade.php ENDPATH**/ ?>