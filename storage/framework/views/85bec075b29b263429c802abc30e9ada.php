        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    ...
                    <?php elseif($title == 4): ?>
                        <h6 class="my-0 text-primary text-center">Leave-wise Daily Leave Register</h6>
                    <?php endif; ?>
