    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="card alert-info alert-top-border padding-card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('ordermanagement.database.basicorders.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\OrderManagement\resources\views\database\basicorders\index.blade.php ENDPATH**/ ?>