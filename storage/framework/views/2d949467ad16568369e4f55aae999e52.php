...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-lg-6 ps-lg-0" style="margin:0px auto;">
            <form action="<?php echo e(route('payroll.tools.process-halfsalary.store')); ?>" id="applicantForm" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'date','id' => 'date','type' => 'date','class' => 'form-control-sm','value' => date('Y-m-d'),'placeholder' => 'Cot Of Date','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'date','id' => 'date','type' => 'date','class' => 'form-control-sm','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(date('Y-m-d')),'placeholder' => 'Cot Of Date','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Payroll\resources\views\tools\process-halfsalary\index.blade.php ENDPATH**/ ?>