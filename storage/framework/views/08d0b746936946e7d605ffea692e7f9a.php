            ...
            $(document).on('click', '#deleteBtn', function(e) {
                ...
                if(purMainId == null || purMainId == undefined || purMainId == ''){
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(url('inventory/database/purrequisitionmains')); ?>/'+purMainId,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                id: purMainId
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules/Inventory\resources/views/database/purrequisition/index.blade.php ENDPATH**/ ?>