                            ...
                            <?php $__currentLoopData = $colorGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $colorGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-<?php echo e($colorGroup->is_active ? 'success' : 'danger'); ?>">
                                            <?php echo e($colorGroup->is_active ? 'Active' : 'Inactive'); ?></p>
                                    </td>
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('inventory.setup.colorgroups.destroy', $colorGroup->id)); ?>"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="<?php echo e(route('inventory.setup.colorgroups.update', $colorGroup->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div class="col-md-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="<?php echo e(route('inventory.setup.colorgroups.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\garments_erp\Modules\Inventory\resources\views\setup\colorgroups\index.blade.php ENDPATH**/ ?>