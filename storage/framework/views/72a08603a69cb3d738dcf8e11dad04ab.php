        ...
        $(document).ready(function() {
            ...
            $("#payBtn").off('click').on('click',function() {
                ...
                $.ajax({
                    ...
                    data: {
                        is_bill_paid: 1,
                        bill_paid_by: "<?php echo e(Auth::user()->id); ?>",
                        bill_paid_date: "<?php echo e($today_date); ?>",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Inventory\resources\views\database\mrracc\index.blade.php ENDPATH**/ ?>