                    ...
                    <?php if($menu->has_child == false && $menu->parent_id == null): ?>
                        <li>
                            <a href="<?php echo e(url($menu->module->url . '/' . $menu->url)); ?>">
                                ...
                                <span data-key="t-module"><?php echo e($menu->title); ?></span>
                            </a>
                        </li>
                    <?php else: ?>
                        <?php if($menu->has_child == true && $menu->parent_id == null): ?>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather=<?php echo e($menu->icon); ?>></i>
                                    <span data-key="t-authorization"><?php echo e($menu->title); ?> (<?php echo e($menu->childs->count()); ?>)</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false" style="max-height: 600px;overflow-x:hidden;overflow-y:auto">
                                    <?php $__currentLoopData = $menu->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a
                                                href="<?php echo e(url($menu->module->url . '/' . $menu->url . '/' . $child->url)); ?>">
                                                <i data-feather=<?php echo e($child->icon); ?>></i>
                                                <span data-key="t-role"><?php echo e($child->title); ?></span>
                                            </a>
                                        </li>
...
<?php /**PATH C:\xampp\htdocs\garments_erp\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>