        ...
        <?php if($title == 1): ?>
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td><strong>Joining Date:</strong> <?php echo e(date('d-m-Y', strtotime($employee->joining_date))); ?></td>
                </tr>
                <tr>
                    <td><strong>Department:</strong> <?php echo e($employee->department); ?></td>
                    <td><strong>Section:</strong> <?php echo e($employee->section); ?></td>
                ...
                <tbody>
                    <?php $__currentLoopData = $employeeRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="text-align:center; <?php echo e($record->attn_type === 'HD' ? 'color:red;font-weight:700;' : ''); ?>">
                                <?php echo e(\Carbon\Carbon::parse($record->work_date)->format('l')); ?>

                            </td>
                            <td><?php echo e($record->start_punch ? \Carbon\Carbon::parse($record->start_punch)->format('h:i A') : '-'); ?></td>
                            <td><?php echo e($record->end_punch ? \Carbon\Carbon::parse($record->end_punch)->format('h:i A') : '-'); ?></td>
            ...
            <table class="signature-section">
                <tr>
                    <td>
                            ...
                            <strong>ID : <?php echo e(str_pad(auth()->user()->employee_id, 8, '0', STR_PAD_LEFT)); ?></strong>
                        <br>--------------------
                    </td>
                    <td>Checked By<br>--------------------</td>
...
<?php /**PATH H:\laragon\www\garments_erp\Modules\Payroll\resources\views\report\timecard\pdf.blade.php ENDPATH**/ ?>