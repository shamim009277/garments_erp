                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="display: flex; justify-content: center; align-items: center;">
                                                <img src="<?php echo e(asset('backend/assets/images/demo.png')); ?>" alt="Photo" id="photo" class="img-fluid" style="width: 160px; height: 220px; object-fit: cover; padding: 2px;">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        $(document).ready(function () {
            ...
            function employeeInfo() {
                ...
                if (employeeId.length >= 6) {
                    $.ajax({
                        url: "<?php echo e(route('hris.database.employee.info')); ?>",
                        type: "POST",
                    data: {
