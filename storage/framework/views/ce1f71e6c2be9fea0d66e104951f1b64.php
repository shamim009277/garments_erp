...
<?php $__env->stopPush(); ?>
    <div class="row">
        ...
        <div class="col-lg-6 ps-lg-0" style="margin:0px auto;">
            <form action="<?php echo e(route('payroll.tools.process-bonus.store')); ?>" id="applicantForm" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="slab1_months" class="form-control form-control-sm <?php $__errorArgs = ['slab1_months'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab1_months', 12)); ?>" placeholder="12" min="0" max="12">
                                        <?php $__errorArgs = ['slab1_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <input type="number" name="slab1_percent" class="form-control form-control-sm <?php $__errorArgs = ['slab1_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab1_percent', 100)); ?>" placeholder="100" min="0" max="100">
                                        <?php $__errorArgs = ['slab1_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-4">
                                        <label class="form-label text-muted small mb-1">Period >= (Months)</label>
                                        <input type="number" name="slab2_months" class="form-control form-control-sm <?php $__errorArgs = ['slab2_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab2_months', 6)); ?>" placeholder="6" min="0">
                                        <?php $__errorArgs = ['slab2_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        <label class="form-label text-muted small mb-1 mt-1">Bonus %</label>
                                        <input type="number" name="slab2_percent" class="form-control form-control-sm <?php $__errorArgs = ['slab2_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab2_percent', 50)); ?>" placeholder="50" min="0" max="100">
                                        <?php $__errorArgs = ['slab2_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-4">
                                        <label class="form-label text-muted small mb-1">Period >= (Months)</label>
                                        <input type="number" name="slab3_months" class="form-control form-control-sm <?php $__errorArgs = ['slab3_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab3_months', 3)); ?>" placeholder="3" min="0">
                                        <?php $__errorArgs = ['slab3_months'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        <label class="form-label text-muted small mb-1 mt-1">Bonus %</label>
                                        <input type="number" name="slab3_percent" class="form-control form-control-sm <?php $__errorArgs = ['slab3_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('slab3_percent', 25)); ?>" placeholder="25" min="0" max="100">
                                        <?php $__errorArgs = ['slab3_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input','data' => ['name' => 'bonus_type','id' => 'bonus_type','class' => 'select2','options' => ['1' => 'Eid-ul Fitr', '2' => 'Eid-ul Adha',],'selected' => old('bonus_type', '1'),'placeholder' => 'Select Bonus Type','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'bonus_type','id' => 'bonus_type','class' => 'select2','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['1' => 'Eid-ul Fitr', '2' => 'Eid-ul Adha',]),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('bonus_type', '1')),'placeholder' => 'Select Bonus Type','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36)): ?>
<?php $attributes = $__attributesOriginalfbd96fa9ceb0dd232d7f99b6c6b44c36; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'base_date','id' => 'base_date','type' => 'date','class' => 'form-control-sm','value' => old('base_date', date('d-m-Y')),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'base_date','id' => 'base_date','type' => 'date','class' => 'form-control-sm','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('base_date', date('d-m-Y'))),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\laragon\www\garments_erp\Modules\Payroll\resources\views\tools\processbonus\index.blade.php ENDPATH**/ ?>