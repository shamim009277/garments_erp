    ...
    <div class="row">
        ...
        <div class="col-12 mb-3">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <form action="<?php echo e(route('hris.database.new-applicants.search')); ?>" method="POST" class="d-flex order-0 order-md-1 mb-2 mb-md-0 me-md-2" style="max-width: 400px;" role="search">
                    <?php echo csrf_field(); ?>
                ...
                <?php if($unique_applicant): ?>
                    <!-- Back Button -->
                    <a href="<?php echo e(route('hris.database.new-applicants.index')); ?>" class="btn btn-sm btn-info d-flex align-items-center order-2 order-md-2">
                                        ...
                                        <li class="nav-custom-item">
                                            ...
                                            <div class="nav-custom-content">
                                                <?php $__currentLoopData = $applicants_date_wises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(route('hris.database.new-applicants.show', $applicant->id)); ?>" style="<?php echo e($unique_applicant && $unique_applicant->id == $applicant->id ? 'color: #FF6C37; background-color: #EBF0F6;' : ''); ?>" class="employee-link"><?php echo e($applicant->id); ?> :: <?php echo e(strtoupper($applicant->name)); ?></a>
                ...
                <div class="card alert-info alert-top-border">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap px-10 py-12" style="padding: 16px 20px">
                        ...
                        <div class="d-flex gap-2 mt-2 mt-md-0">
                            <?php if($unique_applicant): ?>
                                <a href="javascript:void(0);" data-id="<?php echo e($unique_applicant->id); ?>" class="btn btn-danger btn-sm d-flex align-items-center delete-applicant" data-id="<?php echo e($unique_applicant->id); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'entry_date ','label' => 'Entry Date','type' => 'date','placeholder' => 'Enter entry date','value' => old('entry_date', $unique_applicant ? $unique_applicant->entry_date : null),'required' => true,'readonly' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'entry_date ','label' => 'Entry Date','type' => 'date','placeholder' => 'Enter entry date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('entry_date', $unique_applicant ? $unique_applicant->entry_date : null)),'required' => true,'readonly' => true]); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6 pr-0">
                                <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'name_bangla','label' => 'Name Bangla','type' => 'text','placeholder' => 'Enter name bangla','value' => old('name_bangla', $unique_applicant ? $unique_applicant->name_bangla : null),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'name_bangla','label' => 'Name Bangla','type' => 'text','placeholder' => 'Enter name bangla','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name_bangla', $unique_applicant ? $unique_applicant->name_bangla : null)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-search-input','data' => ['name' => 'department_id','id' => 'department_id','label' => 'Department (Apply For)','options' => $departments,'selected' => old('department_id', $unique_applicant ? $unique_applicant->department_id : null),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'department_id','id' => 'department_id','label' => 'Department (Apply For)','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($departments),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('department_id', $unique_applicant ? $unique_applicant->department_id : null)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6 pr-0">
                                <?php if (isset($component)) { $__componentOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-search-input','data' => ['name' => 'designation_id','id' => 'designation_id','label' => 'Designation (Apply For)','options' => $designations,'selected' => old('designation_id', $unique_applicant ? $unique_applicant->designation_id : null),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-search-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'designation_id','id' => 'designation_id','label' => 'Designation (Apply For)','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($designations),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('designation_id', $unique_applicant ? $unique_applicant->designation_id : null)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2)): ?>
<?php $attributes = $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6 pr-0">
                                <?php if (isset($component)) { $__componentOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-search-input','data' => ['name' => 'district_id','label' => 'District','options' => $districts,'selected' => old('district_id', $unique_applicant ? $unique_applicant->district_id : null),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-search-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'district_id','label' => 'District','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($districts),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('district_id', $unique_applicant ? $unique_applicant->district_id : null)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2)): ?>
<?php $attributes = $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input-group','data' => ['name' => 'identification_type','id' => 'identification_type','label' => 'Identification Type','options' => ['1' => 'National ID', '2' => 'Birth Certificate'],'selected' => old('identification_type', $unique_applicant ? $unique_applicant->identification_type : 1),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'identification_type','id' => 'identification_type','label' => 'Identification Type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['1' => 'National ID', '2' => 'Birth Certificate']),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('identification_type', $unique_applicant ? $unique_applicant->identification_type : 1)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6 pr-0" id="nid_section">
                                <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'national_id','label' => 'National ID','id' => 'national_id','type' => 'number','pattern' => '[0-9]{10,17}','minlength' => '10','maxlength' => '17','placeholder' => 'Enter national id','value' => old('national_id', $unique_applicant ? $unique_applicant->national_id : null),'required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'national_id','label' => 'National ID','id' => 'national_id','type' => 'number','pattern' => '[0-9]{10,17}','minlength' => '10','maxlength' => '17','placeholder' => 'Enter national id','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('national_id', $unique_applicant ? $unique_applicant->national_id : null)),'required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6 pr-0" id="birth_certificate_section">
                                <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'birth_certificate_no','label' => 'Birth Certificate No','id' => 'birth_certificate_no','type' => 'number','pattern' => '[0-9]{10,30}','minlength' => '13','maxlength' => '30','placeholder' => 'Enter birth certificate no','value' => old('birth_certificate_no', $unique_applicant ? $unique_applicant->birth_certificate_no : null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'birth_certificate_no','label' => 'Birth Certificate No','id' => 'birth_certificate_no','type' => 'number','pattern' => '[0-9]{10,30}','minlength' => '13','maxlength' => '30','placeholder' => 'Enter birth certificate no','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('birth_certificate_no', $unique_applicant ? $unique_applicant->birth_certificate_no : null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
...
<?php endif; ?>
                            ...
                            <?php if($unique_applicant): ?>
                                <div class="col-lg-4 col-md-6 pr-0">
                                    <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'interviewer_employee_id','label' => 'Interviewer Employee ID','id' => 'interviewer_employee_id','type' => 'number','pattern' => '[0-9]{10,30}','minlength' => '6','maxlength' => '20','placeholder' => 'Enter interviewer employee id','value' => old('interviewer_employee_id', $unique_applicant ? $unique_applicant->interviewer_employee_id : null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'interviewer_employee_id','label' => 'Interviewer Employee ID','id' => 'interviewer_employee_id','type' => 'number','pattern' => '[0-9]{10,30}','minlength' => '6','maxlength' => '20','placeholder' => 'Enter interviewer employee id','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('interviewer_employee_id', $unique_applicant ? $unique_applicant->interviewer_employee_id : null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
...
<?php endif; ?>
                                ...
                                <div class="col-lg-4 col-md-6 pr-0">
                                    <?php if (isset($component)) { $__componentOriginal243648788f657c94d456cacfc3f7cdc3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal243648788f657c94d456cacfc3f7cdc3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-input-group','data' => ['name' => 'interview_status','id' => 'interview_status','label' => 'Interview Status','options' => ['Pending' => 'Pending', 'Selected' => 'Selected', 'Disqualify' => 'Disqualify', 'Not Recruit' => 'Not Recruit',],'selected' => old('interview_status', $unique_applicant ? $unique_applicant->interview_status : 'Pending')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'interview_status','id' => 'interview_status','label' => 'Interview Status','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Pending' => 'Pending', 'Selected' => 'Selected', 'Disqualify' => 'Disqualify', 'Not Recruit' => 'Not Recruit',]),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('interview_status', $unique_applicant ? $unique_applicant->interview_status : 'Pending'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal243648788f657c94d456cacfc3f7cdc3)): ?>
<?php $attributes = $__attributesOriginal243648788f657c94d456cacfc3f7cdc3; ?>
...
<?php endif; ?>
                                ...
                                <div class="col-lg-4 col-md-6 pr-0" id="final_designation_section">
                                    <?php if (isset($component)) { $__componentOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-search-input','data' => ['name' => 'final_designation_id','id' => 'final_designation_id','label' => 'Final Designation','options' => $designations,'selected' => old('final_designation_id', $unique_applicant ? $unique_applicant->final_designation_id : null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select-search-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'final_designation_id','id' => 'final_designation_id','label' => 'Final Designation','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($designations),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('final_designation_id', $unique_applicant ? $unique_applicant->final_designation_id : null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2)): ?>
<?php $attributes = $__attributesOriginal2da57bd62e95163b41a4e48b6d67ccd2; ?>
...
<?php endif; ?>
                                ...
                                <div class="col-lg-4 col-md-6 pr-0" id="proposed_salary_section">
                                    <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'proposed_salary','label' => 'Proposed Salary','id' => 'proposed_salary','type' => 'number','pattern' => '[0-9]{10,30}','placeholder' => 'Enter proposed salary','value' => old('proposed_salary', $unique_applicant ? $unique_applicant->proposed_salary : null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'proposed_salary','label' => 'Proposed Salary','id' => 'proposed_salary','type' => 'number','pattern' => '[0-9]{10,30}','placeholder' => 'Enter proposed salary','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('proposed_salary', $unique_applicant ? $unique_applicant->proposed_salary : null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
...
<?php endif; ?>
                                ...
                                <div class="col-lg-4 col-md-6 pr-0" id="determined_salary_section">
                                    <?php if (isset($component)) { $__componentOriginal66a280159691934507706df376ef5a6a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66a280159691934507706df376ef5a6a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-group','data' => ['name' => 'determined_salary','label' => 'Determined Salary','id' => 'determined_salary','type' => 'number','pattern' => '[0-9]{10,30}','placeholder' => 'Enter determined salary','value' => old('determined_salary', $unique_applicant ? $unique_applicant->determined_salary : null)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-group'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'determined_salary','label' => 'Determined Salary','id' => 'determined_salary','type' => 'number','pattern' => '[0-9]{10,30}','placeholder' => 'Enter determined salary','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('determined_salary', $unique_applicant ? $unique_applicant->determined_salary : null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal66a280159691934507706df376ef5a6a)): ?>
<?php $attributes = $__attributesOriginal66a280159691934507706df376ef5a6a; ?>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                location.href = '<?php echo e(route('hris.database.new-applicants.index')); ?>';
                            } else {
