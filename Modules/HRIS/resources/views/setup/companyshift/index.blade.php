    ...
    <div class="row">
                                    ...
                                    <div id="editModal{{ $shift->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="editForm{{ $shift->id }}" action="{{ route('hris.setup.companywise-shifts.update', $shift->id) }}" method="POST">
        ...
        <div class="col-lg-3">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="{{ route('hris.setup.companywise-shifts.store') }}" method="POST">
                        @csrf
