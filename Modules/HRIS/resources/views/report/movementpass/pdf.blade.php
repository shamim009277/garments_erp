...
<body>
    ...
    @endif
    @if($title == 3)
    <h3 style="text-align:center; margin: 20px 0px;">Department-wise Dates Movement Pass</h3>
    @endif
    @if($title == 4)
    <h3 style="text-align:center; margin: 20px 0px;">Designation-wise Dates Movement Pass</h3>
    @endif
