    ...
    @elseif($title == 4)
            ...
            <tr>
                ...
                <td style="text-align: center; vertical-align: middle;">
                    <div class="font-bold">
                        ...
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp; ফরম-১৫ [ধারা-৩৪,৩৬,৩৭ ও ২৭৭ এবং ৩৪ (১) ও
                        ৩৬৬ (৪) দ্রষ্টব্য] <br>
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp; বয়স ও সক্ষমতার
                        প্রত্যয়নপত্র
                    </div>
                </td>
                ...
                <td style="width: 80px; text-align: right; vertical-align: middle;">
                    <img src="{{ public_path('backend/assets/images/logo-sm.svg') }}" width="120" height="80"
                        alt="Logo">
                </td>
            </tr>
        </table>
        ...
        <table class="nominee-table info-table">
            ...
            <tr>
                ...
                <td> তিনি প্রতিষ্ঠানে নিযুক্ত হইতে ইচ্ছুক, এবং আমার পরীক্ষা হইতে এইর <br> পাওয়া গিয়েছে যে, তাহার বয়
                    ২৬ বৎসর এবং তিনি প্রতিষ্ঠানে <br> প্রাপ্তবয়স্ক/কিশোর হিসাবে নিযুক্ত হইবার যোগ্য । </td>
            </tr>
            <tr>
        ...
        <div class="signature-footer">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div><span style="text-align: right"> রেজিস্টার্ড চিকিৎসকের <br>স্বাক্ষর </span> </div>
                    </td>
                    <td>
                        <div><span> &emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp; সংশিস্নষ্ট ব্যক্তির
                                <br>&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp; স্বাক্ষর/টিপসহি</span></div>
                    </td>
                    <td>
                        <div><span style="text-align: right"> রেজিস্টার্ড চিকিৎসকের <br>স্বাক্ষর </span> </div>
                    </td>
