                ...
                @foreach ($row as $emp)
                    <td style="width: 50%; padding: 5px; vertical-align: top;">
                        ...
                        <div style="border: 1px solid #000; padding: 8px; min-height: 500px; box-sizing: border-box;">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 80%; text-align: center; line-height: 1.2;">
                                            ...
                                            <div style="font-size: 9px;">০১, হারিকেন রোড, দাউলতপুর, জাতীয়বিশ্ববিদ্যালয়, গাজীপুর।</div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <table width="100%"
                                style="font-size: 10px; margin-bottom: 8px; border-collapse: collapse;">
                                <tr>
                            ...
                            <table width="100%" border="1"
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 2px; text-align: right;">
                                        {{ bnNumber(number_format($emp->basic)) }} টাকা</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td style="padding: 2px; text-align: right;">
                                        {{ bnNumber(number_format($emp->medical_allowance)) }} টাকা</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td style="padding: 2px; text-align: right;">
                                        {{ bnNumber(number_format($emp->food_allowance)) }} টাকা</td>
                                </tr>
                                {{-- <tr>
                            ...
                            <table width="100%" border="1"
                                ...
                                <tr>
                                    <td>মোট বেতন</td>
                                    <td>:</td>
                                    <td>{{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                        টাকা</td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="1"
                                ...
                                <tr style="background: #eef;">
                                    ...
                                    <td style="padding: 3px; text-align: right;">
                                        {{ bnNumber(number_format($overtime->hours ?? 0)) }} ঘণ্টা</td>
                                    <td>প্রতি ঘণ্টার হার</td>
                                    <td>:</td>
                                    <td style="padding: 3px; text-align: right;">
                                        {{ bnNumber(number_format($overtime->hourly_rate ?? 0)) }} টাকা</td>
                                </tr>
                            </table>
                            <table width="100%" border="1"
                                style="border-collapse: collapse; font-size: 10px; text-align: left;">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td style="padding: 3px; text-align: middle;">
                                        {{ bnNumber(number_format($overtime->hours ?? 0)) }} ঘণ্টা</td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="1"
                                style="border-collapse: collapse; font-size: 10px; text-align: left;">
                                <tr style="background: #eef;">
                                    <td style="padding: 0px;">নাইট :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                    <td style="padding: 0px;">টিফিন :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                    <td style="padding: 0px;">ইফতার :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                    <td style="padding: 0px;">ডিনার :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                    <td style="padding: 0px;">সা: ছুটি :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                    <td style="padding: 0px;">সর: ছুটি :
                                        {{ bnNumber(number_format($emp->basic + $emp->home_allowance + $emp->medical_allowance + $emp->conveyance + $emp->food_allowance)) }}
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" style="margin-top: 25px; font-size: 9px;">
                                <tr>
                                    <td style="text-align: center; width: 45%;">
                                        <div style="border-top: 1px solid #000; padding-top: 2px;">কর্তৃপক্ষের স্বাক্ষর
                                        </div>
                                    </td>
                                    <td style="width: 10%;"></td>
                                    <td style="text-align: center; width: 45%;">
                                        <div style="border-top: 1px solid #000; padding-top: 2px;">শ্রমিকের স্বাক্ষর
                                        </div>
                                    </td>
                                </tr>
                            </table>
