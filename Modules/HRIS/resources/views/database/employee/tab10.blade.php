                    ...
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="presentAddressTable" width="100%">
                            <tr>
                                ...
                                <td width="70%" style="border: none;"><x-text-input name="nname_bangla" id="nname_bangla" class="form-control-sm" placeholder="নমিনির নাম" /></td>
                            </tr>
                            <tr>
                ...
                <div class="row mt-4" style="border: 1px dotted #2f2f30; padding: 8px 0px;">
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="employeeTable" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="70%" style="border: none;"><x-select-input name="pdistrict_id_bangla" id="pdistrict_id_bangla" class="select2" :options="$districts" selected="{{ $employee_bangla->pdistrict_id_bangla }}" required /></td>
                            </tr>
                            <tr>
                                <th width="30%" style="border: none;">থানা</th>
                                <td width="70%" style="border: none;">
                                    <x-select-input name="pthana_id_bangla" id="pthana_id_bangla" class="select2" :options="$thanas" selected="{{ $employee_bangla->pthana_id_bangla }}" required />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="employeeTable" width="100%">
                            ...
                            <tr>
                                <th width="30%" style="border: none;">জেলা</th>
                                <td width="70%" style="border: none;"><x-select-input name="mdistrict_id_bangla" id="mdistrict_id_bangla" class="select2" :options="$districts" selected="{{ $employee_bangla->mdistrict_id_bangla }}" required /></td>
                            </tr>
                            <tr>
                                <th width="30%" style="border: none;">থানা</th>
                                <td width="70%" style="border: none;">
                                    <x-select-input name="mthana_id_bangla" id="mthana_id_bangla" class="select2" :options="$thanas" selected="{{ $employee_bangla->mthana_id_bangla }}" required />
                                </td>
                            </tr>
                            <tr>
                                <th width="30%" style="border: none;">ডাকঘর</th>
                    ...
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="employeeTable" width="100%">
                            ...
                            <tr>
                                <th width="30%" style="border: none;">জেলা</th>
                                <td width="70%" style="border: none;"><x-select-input name="ndistrict_id_bangla" id="ndistrict_id_bangla" class="select2" :options="$districts" selected="{{ $employee_bangla->ndistrict_id_bangla }}"  /></td>
                            </tr>
                            <tr>
                                <th width="30%" style="border: none;">থানা</th>
                                <td width="70%" style="border: none;">
                                    <x-select-input name="nthana_id_bangla" id="nthana_id_bangla" class="select2" :options="$thanas" selected="{{ $employee_bangla->nthana_id_bangla }}"  />
                                </td>
                            </tr>
                            <tr>
                                <th width="30%" style="border: none;">ডাকঘর</th>
