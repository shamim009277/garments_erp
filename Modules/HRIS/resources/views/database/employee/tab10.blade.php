                ...
                <div class="row" style="border: 1px dotted #2f2f30; padding: 8px 0px;">
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="employeeTable" width="100%">
                            ...
                            <tr>
                                <th width="30%" style="border: none;">নাম <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">পিতার নাম <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">মাতার নাম <span class="text-danger">*</span></th>
                    ...
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="presentAddressTable" width="100%">
                            <tr>
                                <th width="30%" style="border: none;">নমিনির নাম <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">মোবাইল নাম্বার <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">সম্পর্ক <span class="text-danger">*</span></th>
                ...
                <div class="row mt-4" style="border: 1px dotted #2f2f30; padding: 8px 0px;">
                    <div class="col-lg-4 col-md-6 pe-lg-0 pe-md-0">
                        <table class="table table-striped mb-0" id="employeeTable" width="100%">
                            ...
                            <tr>
                                <th width="30%" style="border: none;">জেলা <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">থানা <span class="text-danger">*</span></th>
                            ...
                            <tr>
                                <th width="30%" style="border: none;">ডাকঘর <span class="text-danger">*</span></th>
                                <td width="70%" style="border: none;">
                            ...
                            <tr>
                                <th width="30%" style="border: none;">বাড়ি নং/রাস্তা নং /গ্রাম <span class="text-danger">*</span></th>
                                <td width="70%" style="border: none;">
