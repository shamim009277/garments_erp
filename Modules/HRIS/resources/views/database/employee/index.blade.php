                ...
                <div class="card-body" style="min-height: 457px;max-height: 457px; overflow-y: auto;">
                    <ul class="nav-custom">
                        @foreach ($unique_department as $department)
                            @php
                                $applicant_date_wises = collect($applicants)
                                ...
                                <div class="col-lg-6 col-md-6 pe-lg-0">
                                    <table class="table table-striped mb-0" id="presentAddressTable" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="70%" style="border: none;"><x-text-input name="confirm_date" id="confirm_date" type="date" class="form-control-sm" placeholder="Confirm Date" required readonly /></td>
                                        </tr>
                                        <tr>
                                            <th style="border: none;">&nbsp; &nbsp;</th>
                                            <td style="border: none;">&nbsp; &nbsp;</td>
                        ...
                        <div class="col-lg-4 pe-lg-0">
                            <table class="table table-striped" id="employeeTable" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="70%" style="border: none;"><x-select-input name="reference_shift" id="reference_shift" class="select2" :options="$shifts" selected="G" required /></td>
                                </tr>
                                <tr>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#joining_date,#reference_date').attr('min', today);
            ...
            $('#joining_date').on('change', function () {
                ...
                $('#reference_date').val(joiningDateVal);
                ...
                if (!isNaN(joiningDate.getTime())) {
                    ...
                    $('#confirm_date').val(formattedDate);
                }
            });
