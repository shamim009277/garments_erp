...
use Modules\Inventory\Http\Requests\Setup\SizeGroupRequest;
...
class SizeGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('inventory::setup.sizegroups.index', compact('sizeGroups'));
    }
    ...
    {
        return view('inventory::setup.sizegroups.create');
    }
    ...
    public function store(SizeGroupRequest $request)
    {
        ...
        try {
            ...
            $sizeGroup->save();
            DB::commit();
            return redirect()->route('inventory.setup.sizegroups.index')->with('success', 'Size Group created successfully');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        return view('inventory::setup.sizegroups.show');
    }
    ...
    public function edit($id)
    {
        ...
        return view('inventory::setup.sizegroups.edit', compact('sizeGroup'));
    }
    ...
    public function update(SizeGroupRequest $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('inventory.setup.sizegroups.index')->with('success', 'Size Group updated successfully');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $sizeGroup->delete();
            DB::commit();
            return redirect()->route('inventory.setup.sizegroups.index')->with('success', 'Size Group deleted successfully');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->with('error', 'Failed to delete Size Group: ' . $e->getMessage());
        }
    }
    // Toggle Status
    // public function toggleStatus(Request $request)
    // {
    //     return $this->toggleStatus(SizeGroup::class, $request->id);
    // }
}
