...
class BasicOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'buyer_id' => 'nullable|exists:inventory_setup_buyer,id',
            'style_no' => [
                'nullable',
                'string',
                Rule::unique('inventory_databases_orders', 'style_no')->ignore($basicOrderId),
            ],
            ...
            'bw_gsm' => 'nullable|numeric',
            'finished_dia' => 'nullable|numeric',
            'finish_type' => 'nullable|string',
            'wash_type' => 'nullable|string',
            'unit_price' => 'nullable|numeric',
            'cm_price_per_dzn' => 'nullable|numeric',
            'order_date' => 'required|date',
            'extra_cutting_percent' => 'nullable|numeric',
            'fabric_booking_needed' => 'nullable|boolean',
            'fabric_consumption_kg_dz' => 'nullable|numeric',
            'kd_allowance_percent' => 'nullable|numeric',
            'cutting_consumption_yards_pcs' => 'nullable|numeric',
            'booking_consumption_yards_pcs' => 'nullable|numeric',
            'delivery_mode' => 'nullable|string',
            'delivery_date' => 'nullable|date',
            'trims_required_approved' => 'nullable|boolean',
            'closed' => 'nullable|boolean',
            'fabric_from_stock' => 'nullable|boolean',
            'style_complexity_notes' => 'nullable|string',
            'print_type' => 'nullable|string',
            'embroidery_type' => 'nullable|string',
            'garment_dye_price_per_dzn' => 'nullable|numeric',
            'embroidery_dye_price_per_dzn' => 'nullable|numeric',
            'print_price_per_dzn' => 'nullable|numeric',
            'embroidery_price_per_dzn' => 'nullable|numeric',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'order_quantity.integer' => 'Order quantity must be an integer',
            'buyer_id.exists' => 'Buyer does not exist',
            'style_no.string' => 'Style no must be a string',
            'style_no.unique' => 'Style no already exists',
