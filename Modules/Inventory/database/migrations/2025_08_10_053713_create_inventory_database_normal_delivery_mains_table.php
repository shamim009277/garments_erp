...
return new class extends Migration
{
    ...
    {
        Schema::create('inventory_database_normal_delivery_mains', function (Blueprint $table) {
            ...
            $table->foreignId('forward_by_id')->nullable()->constrained('users')->onDelete('restrict');
            $table->date('forward_date')->nullable();
            //Priced
            $table->tinyInteger('is_priced')->default(0);
            $table->foreignId('priced_by_id')->nullable()->constrained('users')->onDelete('restrict');
            $table->date('priced_date')->nullable();
            //Confirmed
            $table->tinyInteger('is_confirmed')->default(0);
            $table->foreignId('confirmed_by_id')->nullable()->constrained('users')->onDelete('restrict');
            ...
            $table->foreignId('fapproved_by_id')->nullable()->constrained('users')->onDelete('restrict');
