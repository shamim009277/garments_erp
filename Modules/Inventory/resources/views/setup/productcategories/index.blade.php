    ...
    <div class="row">
                        ...
                        <tbody>
                            @foreach ($productCategories as $key => $productCategory)
                                <tr>
                                    ...
                                    <td>{{ $productCategory->is_active ? 'Active' : 'Inactive' }}</td>
                                    <td>
                                        ...
                                        <form
                                            action="{{ route('inventory.setup.productcategories.destroy', $productCategory->id) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="moduleForm"
                                                    action="{{ route('inventory.setup.productcategories.update', $productCategory->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
        ...
        <div class="col-md-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="{{ route('inventory.setup.productcategories.store') }}" method="POST">
                        @csrf
