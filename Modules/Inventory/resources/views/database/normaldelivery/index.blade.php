                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form id="addFormMain" action="{{ route('inventory.database.normaldeliverymains.store') }}" method="POST">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <table width="100%">
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td width="65%">
                                                                            <x-select-search-input id="required_by_id" name="required_by_id" :options="$users->pluck('name', 'id')" :selected="old('required_by')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "{{ url('inventory/database/normaldeliverymains') }}/"+id,
            ...
            $('#addFormMain').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('inventory.database.normaldeliverymains.store') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/normaldeliverymains/multiplestatus') }}/"+req_id,
                    data: {
                        is_done: 1,
            ...
            $(document).on('click', '#deleteBtn', function(e) {
                ...
                if(purMainId == null || purMainId == undefined || purMainId == ''){
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('inventory/database/normaldeliverymains') }}/'+purMainId,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: purMainId
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('inventory.database.normaldeliverymains.search') }}",
                    data: {
                        search: search,
                        match: match,
                        _token: "{{ csrf_token() }}"
            ...
            $('#search_data').on('select2:select', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('inventory.database.normaldeliverydetails.store') }}",
                    data: {
                        item_id: itemId,
                        req_no: req_no,
                        _token: "{{ csrf_token() }}"
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/normaldeliverydetails') }}/"+id,
                    data: {
                        req_qty: reqQty,
                        for_qty: reqQty,
                        app_qty: reqQty,
