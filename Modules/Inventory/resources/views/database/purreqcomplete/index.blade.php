    ...
    <script>
        $(document).ready(function() {
            ...
            function getReqMain(id){
                $.ajax({
                    type: 'GET',
                    url: "{{ url('inventory/database/purreqcompleted') }}/"+id,
                    success: function(data) {
                        console.log(data);
                        ...
                        // $('#printBtn').attr('href', '{{ url('inventory/database/purreqpending/pdf') }}/'+id);
            ...
            function searchRequisition(search) {
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('inventory.database.purreqcompleted.search') }}",
                    data: {
                        search: search,
                        _token: "{{ csrf_token() }}"
                    },
