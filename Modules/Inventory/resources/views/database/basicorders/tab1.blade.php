            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">GSM <span
                                class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="gsm" id="gsm" value="{{ $basicorder->gsm }}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">BW GSM <span
                                class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="bw_gsm" id="bw_gsm" value="{{ $basicorder->bw_gsm }}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">Finish Diameter <span
                                class="text-danger">*</span></label>
                        <input class="form-control" type="number" name="finished_dia" id="finished_dia" value="{{ $basicorder->finished_dia }}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="mb-3">
                ...
                <div class="col-lg-3">
                    <div class="mb-3">
                        <label for="example-text-input" class="form-label">unit price <span
                                class="text-danger">*</span></label>
                        <input class="form-control" type="number" name="unit_price" id="unit_price" value="{{ $basicorder->unit_price }}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="mb-3">
                ...
                <div class="col-lg-3">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="delivery_date" id="delivery_date" value="{{ $basicorder->delivery_date }}">
                    </div>
                </div>
