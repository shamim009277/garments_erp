            ...
            <div class="card alert-primary alert-top-border padding-card">
                ...
                <div class="card-body">
                    <ul class="list-group" style="min-height: 690px; overflow-y: auto;" id="gatepurmrr-list">
                        @foreach ($gatepurmrrs as $gatepurmrr)
                            <li class="list-group-item list-group-item-action p-2 border-0 pur-main" data-id="{{ $gatepurmrr->id }}">{{ $gatepurmrr->mrr_date }} - {{ $gatepurmrr->mrr_no }}</li>
                        @endforeach
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card alert-info alert-top-border padding-card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <x-primary-button class="btn-sm me-2" data-bs-toggle="modal" data-bs-target="#addModal">Add New</x-primary-button>
                                    <x-info-button  class="btn-sm me-2" data-bs-toggle="modal" data-bs-target="#updateModal">Update</x-info-button>
                                     ...
                                     <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form id="addFormMain" action="{{ route('inventory.database.gatepurmrrmains.store') }}" method="POST">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <table width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="65%">
                                                                            <x-text-input id="mrr_date" name="mrr_date" class="form-control w-100" type="date" readonly :value="$today_date" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Gate Entry By</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="gate_entry_by" name="gate_entry_by" class="form-control w-100" type="text" readonly :value="Auth::user()->name" required />
                                                                            <x-text-input id="gate_entry_id" name="gate_entry_id" class="form-control w-100" type="text" readonly :value="Auth::user()->id" hidden />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Received By  <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-select-search-input id="received_by_id" name="received_by_id" :options="$users->pluck('name', 'id')" :selected="old('received_by')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Driver Name <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-text-input id="driver_name" name="driver_name" class="form-control w-100" type="text" :value="old('driver_name')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Vehicle No</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="vehicle_no" name="vehicle_no" class="form-control w-100" type="text" :value="old('vehicle_no')"/>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <table width="100%">
                                                                    <tr >
                                                                        ...
                                                                        <td width="65%">
                                                                            <x-select-search-input name="organization_id" :options="$organizations->pluck('name', 'id')" :selected="old('organization_id')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Supplier <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-select-search-input name="supplier_id" :options="$suppliers->pluck('name', 'id')" :selected="old('supplier_id')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Act Challan No</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="act_challan_no" name="act_challan_no" class="form-control w-100" type="text" :value="old('act_challan_no')" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Note</th>
                                                                ...
                                                                <table width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="65%">
                                                                            ...
                                                                            <x-text-input id="u_mrr_date" name="mrr_date" class="form-control w-100" type="date" readonly :value="$today_date" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Gate Entry By</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="u_gate_entry_by" name="gate_entry_by" class="form-control w-100" type="text" readonly :value="Auth::user()->name" required />
                                                                            <x-text-input id="u_gate_entry_by_id" name="gate_entry_by_id" class="form-control w-100" type="text" readonly :value="Auth::user()->id" hidden />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Received By</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="u_received_by" name="received_by" class="form-control w-100" type="text" readonly :value="Auth::user()->name" required />
                                                                            <x-text-input id="u_received_by_id" name="received_by_id" class="form-control w-100" type="text" readonly :value="Auth::user()->id" hidden />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Vehicle No <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-text-input id="u_vehicle_no" name="vehicle_no" class="form-control w-100" type="text" :value="old('vehicle_no')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Driver Name <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-text-input id="u_driver_name" name="driver_name" class="form-control w-100" type="text" :value="old('driver_name')" required />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <table width="100%">
                                                                    ...
                                                                    <tr >
                                                                        <th width="35%">Supplier <span style="color: red">*</span></th>
                                                                        <td width="65%">
                                                                            <x-select-input id="u_supplier_id" name="supplier_id" :options="$suppliers->pluck('name', 'id')" :selected="old('supplier_id')" required />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Act Challan No</th>
                                                                        <td width="65%">
                                                                            <x-text-input id="u_act_challan_no" name="act_challan_no" class="form-control w-100" type="text" :value="old('act_challan_no')" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr >
                                                                        <th width="35%">Note</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/gatepurmrrdetails') }}/"+id,
                    data: {
            ...
            function getMrrMain(id){
                $.ajax({
                    type: 'GET',
                    url: "{{ url('inventory/database/gatepurmrrmains') }}/"+id,
                    success: function(data) {
                        console.log(data);
            ...
            function searchGatePurMrr(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('inventory.database.gatepurmrrmains.search') }}",
                    data: {
                        search: search,
                        match: match,
                        _token: "{{ csrf_token() }}"
            ...
            $('#search_data').select2({
                    ...
                    ajax: {
                        type: 'PUT',
                        url: "{{ route('inventory.database.gatepurmrr.search') }}",
                        dataType: 'json',
                        delay: 250,
                        cache: true,
            ...
            $('#search_data').on('select2:select', function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/gatepurmrr/reqmains') }}",
                    data: {
                        id: itemId,
                        mrr_id: mrr_id,
                        _token: "{{ csrf_token() }}"
            ...
            function receiveItem(itemId) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('inventory.database.gatepurmrrdetails.store') }}",
                    data: {
                        mrr_id: mrrId,
                        item_id: itemId,
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/gatepurmrrmains/multiplestatus') }}/"+req_id,
                    data: {
                        is_done: 1,
            ...
            $('#addFormMain').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('inventory.database.gatepurmrrmains.store') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#updateFormMain').on('submit', function(e) {
                ...
                if ($('#u-document')[0].files.length > 0) {
                    ...
                    // Send via AJAX
                     $.ajax({
                    url: '{{ url('inventory/database/gatepurmrrmains/document-update') }}/'+id,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
