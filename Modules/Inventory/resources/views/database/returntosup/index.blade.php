                                    ...
                                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form id="addFormMain" action="{{ route('inventory.database.returntosupmains.store') }}" method="POST">
    ...
    <script>
        $(document).ready(function() {
            ...
            function getChallanMain(id){
                $.ajax({
                    type: 'GET',
                    url: "{{ url('inventory/database/returntosupmains') }}/"+id,
                    success: function(data) {
                        ...
                        $('#printgtBtn').attr('href', "{{ url('inventory/database/returntosupmains/gtpdf') }}/"+id);
                        $('#printchBtn').attr('href', "{{ url('inventory/database/returntosupmains/chpdf') }}/"+id);
            ...
            $('#addFormMain').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('inventory.database.returntosupmains.store') }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#done-btn").off('click').on('click',function() {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/returntosupmains/multiplestatus') }}/"+challan_id,
                    data: {
                        is_done: 1,
            ...
            $(document).on('click', '#deleteBtn', function(e) {
                ...
                if(challanMainId == null || challanMainId == undefined || challanMainId == ''){
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('inventory/database/returntosupmains') }}/'+challanMainId,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: challanMainId
            ...
            function searchRequisition(match, search) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('inventory.database.returntosupmains.search') }}",
                    data: {
                        search: search,
                        match: match,
                        _token: "{{ csrf_token() }}"
            ...
            $('#search_data').select2({
                    ...
                    ajax: {
                        type: 'PUT',
                        url: "{{ route('inventory.database.returntosup.search') }}",
                        dataType: 'json',
                        delay: 250,
                        cache: true,
            ...
            $('#search_data').on('select2:select', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('inventory.database.returntosupdetails.store') }}",
                    data: {
                        item_id: itemId,
            ...
            function updateItem(id){
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ url('inventory/database/returntosupdetails') }}/"+id,
                    data: {
                        unit_id: unit_id,
