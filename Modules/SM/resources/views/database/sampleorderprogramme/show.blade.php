                ...
                <ul class="nav-custom">
                    <li class="nav-custom-item">
                        ...
                        <ul class="nav-custom-content">
                            ...
                            <li class="nav-custom-item"><a href="{{ route('sms.database.sampleorderprogramme.show', $x->id) }}" class="nav-custom-link {{ $order->id == $x->id ? 'active' : '' }}">{{ $x->order_code }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                </ul>
                                    ...
                                    <div class="modal fade" id="editModal{{ $sample->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $sample->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('sms.database.sampleorderprogramme.update', $sample->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
