...
return new class extends Migration
{
    ...
    public function up(): void {
        Schema::create('payroll_tools_process_salary', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('ot_payable', ['Y', 'N'])->default('N');
            ...
            $table->decimal('ot_hour', 18, 2)->default(0);
            $table->decimal('ot_amount', 18, 2)->default(0);
            $table->decimal('total_ot_hour', 18, 2)->default(0);
            $table->decimal('total_ot_amount', 18, 2)->default(0);
    ...
    public function down(): void {
        Schema::dropIfExists('payroll_tools_process_salary');
    }
};
