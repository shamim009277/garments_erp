            ...
            <form action="{{ route('payroll.tools.read-machinedata.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card alert-primary alert-top-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            {{-- <td width="60%" id="all_department_section">
                                                <x-text-input name="file" id="file" accept=".txt"
                                                    class="form-control-sm" type="file" autocomplete="off" required />
                                            </td> --}}
                                            <td width="60%" id="all_department_section">
                                                <x-text-input name="file[]" id="file" accept=".txt"
                                                    class="form-control-sm" type="file" multiple autocomplete="off"
                                                    required />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="60%" id="user_section">
                                                <x-text-input name="start_date" id="start_date" class="form-control-sm"
                                                    type="date" autocomplete="off" placeholder="Start Date" required />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="40%">
                                            ...
                                            <td width="60%" id="category_section">
                                                <x-input-group name="end_date" id="end_date" class="form-control-sm"
                                                    type="date" autocomplete="off" placeholder="End Date" required />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="card-footer" style="padding:15px 16px;">
                        <x-primary-button id="submitBtn" class="btn-sm submitBtn float-end" type="submit">Start
                            Process</x-primary-button>
                    </div>
                </div>
            </form>
        </div>
