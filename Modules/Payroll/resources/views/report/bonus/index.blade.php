    ...
    <div class="row">
        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                ...
                <form id="employeeListingForm" action="{{ route('payroll.report.bonus-report.report.preview') }}" method="POST" target="_blank">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Titles -->
                                        ...
                                        <table class="table table-sm" width="100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Date</th>
                                                    <td width="60%">
                                                        <x-select-input name="bonus_type" id="bonus_type" class="select2" :options="['1' => 'Eid-ul Fitr', '2' => 'Eid-ul Adha',]" :selected="old('bonus_type', '1')" placeholder="Bonus Type" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Month</th>
