        ...
        <div class="col-lg-12 pr-0">
            <div class="card alert-primary alert-top-border padding-card">
                <div class="card-header">
                    <h6 class="my-0 text-primary"> <i data-feather="list" width="16" height="16"></i> Employee Salary Report</h6>
                </div>
                <form id="employeeListingForm" action="{{ route('payroll.report.salary-report.report.preview') }}" method="POST" target="_blank">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Titles -->
                                ...
                                <div class="card alert-info alert-top-border">
                                    ...
                                    <div class="card-body" style="max-height:400px;min-height:400px; overflow-y: auto;">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="title1">Department-wise Salary Report</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="title2" name="title" value="2"class="form-check-input titles">
                                            <label class="form-check-label" for="title2">Individual Card Wise Monthly Salary Report</label>
                                        </div>
                                       </br><br>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="60%" id="organization_section">
                                                        <x-select-input name="organization_id" id="organization_id" class="select2" :options="$organizations" selected="{{ old('organization_id', 1) }}" placeholder="Organization" disabled/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="40%"> Employee ID</th>
                                                    <td width="60%">
                                                        <x-text-input name="employee_id" id="employee_id" label="" class="form-control-sm multiselect" multiple="multiple" placeholder="Employee ID" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
