    ...
    <footer>
        ...
        <table class="table table-bordered table-hover table-striped mb-0">
            <thead>
                ...
                <tr>
                    <th width="25%">Interview Operation</th>
                    <th width="25%">MC</th>
                    <th width="5%" class="text-right">Declare</th>
                    <th width="5%" class="text-right">1st</th>
                    <th width="5%" class="text-right">2nd</th>
                    <th width="5%" class="text-right">3rd</th>
                    <th width="5%" class="text-right">4th</th>
                    <th width="5%" class="text-right">5th</th>
                    <th width="5%" class="text-right">Avg</th>
                    <th width="5%" class="text-right">SMV</th>
                    <th width="6%" class="text-right">Target</th>
                    <th width="8%" class="text-right">Efficiency</th>
                </tr>
            </thead>
            <tbody>
                @if($assessment->details && count($assessment->details) > 0)
                    ...
                    <tr>
                        ...
                        <td>N/A</td>
                        <td>{{ count($assessment->details)*3 }}</td>
                        <td>0</td>
                        <td>0</td>
                        <td>0</td>
                        <td>0</td>
                        <td>0</td>
                        <td>{{ $assessment->details->where('status', 1)->count() * 3 }}</td>
                        <td>N/A</td>
                        <td>N/A</td>
                ...
                @php
                    $avgeff = $assessment->efficiency;
                @endphp 

                @foreach($assessment->machineProcesses as $process)
                    <tr>
                        <td>
                            {{ $process->processName->process_name ?? 'N/A' }}
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="summary-header"></td>
                    <td class="summary-header"></td>
                    <td class="summary-header">{{ number_format($avgeff, 3) }} %</td>
                </tr>
            </tfoot>
        </table>
        <hr>
