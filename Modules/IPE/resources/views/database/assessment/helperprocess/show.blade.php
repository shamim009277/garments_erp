    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="card alert-info alert-top-border">
                ...
                {{-- General Section --}}
                <x-ipe::question :title="'Basic Questions'" :helperQuestions="$helper_questions" :uniqueApplicant="$unique_applicant" :perMark="3"
                    :disabled="$disabled" />
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <x-primary-button class="float-start btn-sm"
                                                            :disabled="$unique_applicant->is_done == 1">Save</x-primary-button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
