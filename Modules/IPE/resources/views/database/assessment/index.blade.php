                ...
                <div class="card alert-info alert-top-border">
                    ...
                    <div class="card-body" style="min-height: 400px;max-height: 400px; overflow-y: auto;">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 pr-0">
                                <x-input-group name="name" label="Name" id="name" type="text" placeholder="Enter name"
                                    :value="old('name', $unique_applicant ? $unique_applicant->name : null)" required readonly />
                            </div>
                            <div class="col-lg-4 col-md-6 pr-0">
                            ...
                            <div class="col-lg-4 col-md-6 pr-0">
                                <x-input-group name="entry_date" id="entry_date" label="Entry Date" type="text" pattern="[0-9]{2}"
                                    placeholder="Enter entry date" :value="old('entry_date', $unique_applicant ? $unique_applicant->entry_date : null)" required readonly />
                            </div>

                            <div class="col-lg-4 col-md-6 pr-0">
                                <x-input-group name="mobile" id="mobile" label="Mobile" type="text" pattern="(01)[0-9]{9}"
                                    maxlength="11" placeholder="Enter mobile" :value="old('mobile', $unique_applicant ? $unique_applicant->mobile : null)" required readonly />
                            </div>

                            <div class="col-lg-4 col-md-6 pr-0">
                                <x-input-group name="line" id="line" label="Line" type="text" pattern="[0-9]"
                                    placeholder="Enter line" :value="old('line', $unique_applicant ? $unique_applicant->line : null)" />
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 pr-0">
                                <x-select-input-group name="designation_id" id="designation_id" label="Designation" class="select2" :options="$designations"
                                    :selected="old(
                                        'designation_id',
                            ...
                            <div class="col-lg-3 col-md-6 pr-0">
                                <x-input-group name="exp_month" label="Experience Month" type="text" pattern="[0-9]"
                                    placeholder="Enter experience month" :value="old('exp_month', $unique_applicant ? $unique_applicant->exp_month : null)" />
                            </div>
                        </div>
                    </div>
