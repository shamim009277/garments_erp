...
// use Modules\IPE\Database\Factories\Database/AssessmentDetailsHelperFactory;

class AssessmentDetailsHelper extends Model
{
    use HasFactory;
     ...
     */
    protected $table = 'ipe_database_assessment_details_helper';
