...
return new class extends Migration
{
    ...
    {
        Schema::create('ipe_database_assessment_processes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('process_id')
                ->references('id')->on('ipe_setup_process')
                ->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('ipe_database_assessment_processes');
    }
};
