    ...
    <div class="row">
                                    ...
                                    <div id="editModal{{ $country->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form id="editForm{{ $country->id }}" action="{{ route('ordermanagement.setup.countries.update', $country->id) }}" method="POST">
        ...
        <div class="col-lg-4">
            <div class="card alert-info alert-top-border">
                ...
                <div class="card-body">
                    <form id="moduleForm" action="{{ route('ordermanagement.setup.countries.store') }}" method="POST">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            $('.country-toggle').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('ordermanagement.setup.countries.toggle') }}',
                    type: 'POST',
                    data: {
                        id: id,
                        status: status,
        ...
        $(document).on('click', '.delete-country', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('ordermanagement.setup.countries.delete') }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            id: countryId
