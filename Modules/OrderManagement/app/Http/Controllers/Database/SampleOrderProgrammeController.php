...
class SampleOrderProgrammeController extends Controller
{
    public function index()
    {
        ...
        return view('ordermanagement::database.sampleorderprogramme.index', compact('orders'));
    }
    ...
    public function show($id)
    {
        ...
        $samples = SampleOrderProgramme::where('initial_order_id', $id)
            ->with(['colors', 'sampleType', 'composition', 'item', 'fabricTreatment', 'sizes'])
            ->get();
        ...
        return view('ordermanagement::database.sampleorderprogramme.show', compact('orders', 'order', 'samples', 'colors', 'sampleTypes', 'compositions', 'items', 'fabricTreatments', 'sizes', 'fabricSources', 'washTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'tri_acr_deadline' => 'nullable|date',
        ...
        try {
            ...
            if ($request->has('sizes_id')) {
                $programme->sizes()->attach($request->sizes_id);
            }
