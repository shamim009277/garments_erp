...
use Modules\OrderManagement\Http\Requests\Setup\ColorGroupRequest;
...
class ColorGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ordermanagement::setup.colorgroups.index', compact('colorGroups'));
    }
    ...
    {
        return view('ordermanagement::setup.colorgroups.create');
    }
    ...
    public function store(ColorGroupRequest $request)
    {
        ...
        try {
            ...
            $colorGroup->save();
            DB::commit();
            return redirect()->route('ordermanagement.setup.colorgroups.index')->with('success', 'Color Group created successfully');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function show($id)
    {
        ...
        return view('ordermanagement::setup.colorgroups.show', compact('colorGroup'));
    }
    ...
    {
        $colorGroup = ColorGroup::findOrFail($id);
        return view('ordermanagement::setup.colorgroups.edit', compact('colorGroup'));
    }
    ...
    public function update(ColorGroupRequest $request, $id)
    {
        ...
        try {
            ...
            $colorGroup->save();
            DB::commit();
            return redirect()->route('ordermanagement.setup.colorgroups.index')->with('success', 'Color Group updated successfully');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to delete Color Group: ' . $e->getMessage(),
            ]);
        }
    }
    //
    public function toggleStatus(Request $request) {
        return $this->toggleStatusTrait($request, ColorGroup::class);
    }
